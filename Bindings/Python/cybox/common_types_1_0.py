...
class ExtractedStringType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'String_Value':
            ...
            self.validate_StringObjectAttributeType(self.String_Value)    # validate type StringObjectAttributeType
            ...
            self.validate_HexBinaryObjectAttributeType(self.Address)    # validate type HexBinaryObjectAttributeType
        elif nodeName_ == 'Length':
            obj_ = None
            self.set_Length(obj_)
            self.validate_PositiveIntegerObjectAttributeType(self.Length)    # validate type PositiveIntegerObjectAttributeType
        elif nodeName_ == 'Language':
            Language_ = child_.text
            Language_ = self.gds_validate_string(Language_, node, 'Language')
            self.Language = Language_
            self.validate_StringObjectAttributeType(self.Language)    # validate type StringObjectAttributeType
        elif nodeName_ == 'English_Translation':
            English_Translation_ = child_.text
            English_Translation_ = self.gds_validate_string(English_Translation_, node, 'English_Translation')
            self.English_Translation = English_Translation_
            self.validate_StringObjectAttributeType(self.English_Translation)    # validate type StringObjectAttributeType
