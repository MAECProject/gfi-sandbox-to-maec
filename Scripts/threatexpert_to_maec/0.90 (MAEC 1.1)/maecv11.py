...
try:
    ...
    class GeneratedsSuper(object):
        ...
        def format_float(self, input_data, input_name=''):
            return '%f' % input_data
        def format_float2(self, input_data, input_name=''):
...
class malwareMetaData(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='malwareMetaData', namespacedef_=''):
        ...
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, 'metadata:', name_)
            showIndent(outfile, level)
            outfile.write('</%s%s>\n' % (namespace_, name_))
        else:
            outfile.write('/>\n')
...
class MAEC_Bundle(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_='maec:', name_='MAEC_Bundle'):
        outfile.write(' id=%s' % (quote_attrib(self.id), ))
        outfile.write(' schema_version="%s"' % self.format_float2(self.schema_version, input_name='schema_version'))
