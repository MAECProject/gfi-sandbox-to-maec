...
class UserAccountObjectType(account_object.AccountObjectType):
    ...
    def exportChildren(self, outfile, level, namespace_='UserAccountObj:', name_='UserAccountObjectType', fromsubclass_=False):
        if self.User_ID is not None:
            self.User_ID.export(outfile, level, 'UserAccountObj:', name_='User_ID')
        if self.Full_Name is not None:
            self.Full_Name.export(outfile, level, 'UserAccountObj:', name_='Full_Name')
        if self.Group_List is not None:
            self.Group_List.export(outfile, level, 'UserAccountObj:', name_='Group_List')
        if self.Home_Directory is not None:
            self.Home_Directory.export(outfile, level, 'UserAccountObj:', name_='Home_Directory')
        if self.Last_Login is not None:
            self.Last_Login.export(outfile, level, 'UserAccountObj:', name_='Last_Login')
        if self.Privilege_List is not None:
            self.Privilege_List.export(outfile, level, 'UserAccountObj:', name_='Privilege_List')
        if self.Script_Path is not None:
            self.Script_Path.export(outfile, level, 'UserAccountObj:', name_='Script_Path')
        if self.Username is not None:
            self.Username.export(outfile, level, 'UserAccountObj:', name_='Username')
        if self.User_Password_Age is not None:
            self.User_Password_Age.export(outfile, level, 'UserAccountObj:', name_='User_Password_Age')
