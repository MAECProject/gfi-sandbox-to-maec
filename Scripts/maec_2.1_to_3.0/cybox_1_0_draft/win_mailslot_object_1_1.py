...
#
# Generated Fri Nov 30 13:20:23 2012 by generateDS.py version 2.7c.
#
...
class WindowsMailslotObjectType(common_types_1_0.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='WinMailslotObj:', name_='WindowsMailslotObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='WinMailslotObj:', name_='WindowsMailslotObjectType', fromsubclass_=False, pretty_print=True):
        super(WindowsMailslotObjectType, self).exportChildren(outfile, level, 'WinMailslotObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Handle is not None:
            self.Handle.export(outfile, level, 'WinMailslotObj:', name_='Handle', pretty_print=pretty_print)
        if self.Max_Message_Size is not None:
            self.Max_Message_Size.export(outfile, level, 'WinMailslotObj:', name_='Max_Message_Size', pretty_print=pretty_print)
        if self.Name is not None:
            self.Name.export(outfile, level, 'WinMailslotObj:', name_='Name', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Handle is not None:
            showIndent(outfile, level)
            outfile.write('Handle=model_.win_handle_object_1_2.WindowsHandleListType(\n')
            self.Handle.exportLiteral(outfile, level, name_='Handle')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Max_Message_Size is not None:
            showIndent(outfile, level)
            outfile.write('Max_Message_Size=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
        ...
        if self.Read_Timeout is not None:
            showIndent(outfile, level)
            outfile.write('Read_Timeout=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
