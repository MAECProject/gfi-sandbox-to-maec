...
#
# Generated Fri Nov 30 13:17:39 2012 by generateDS.py version 2.7c.
#
...
class MutexObjectType(common_types_1_0.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='MutexObj:', name_='MutexObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='MutexObj:', name_='MutexObjectType', fromsubclass_=False, pretty_print=True):
        super(MutexObjectType, self).exportChildren(outfile, level, 'MutexObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Name is not None:
            self.Name.export(outfile, level, 'MutexObj:', name_='Name', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Name is not None or
            super(MutexObjectType, self).hasContent_()
            ):
            return True
        else:
            return False
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        super(MutexObjectType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
