...
#
# Generated Fri Nov 30 13:20:31 2012 by generateDS.py version 2.7c.
#
...
class NLRouteOriginType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(NLRouteOriginType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
    ...
    def export(self, outfile, level, namespace_='WinNetworkRouteEntryObj:', name_='NLRouteOriginType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='NLRouteOriginType')
        if self.hasContent_():
            outfile.write('>')
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinNetworkRouteEntryObj:', name_='NLRouteOriginType'):
        super(NLRouteOriginType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='NLRouteOriginType')
...
class WindowsNetworkRouteEntryObjectType(network_route_entry_object_1_0.NetworkRouteEntryObjectType):
    """The WindowsNetworkRouteEntryObjectType type is intended to
    characterize Windows network routing table entries."""
    subclass = None
    superclass = network_route_entry_object_1_0.NetworkRouteEntryObjectType
    def __init__(self, object_reference=None, is_publish=None, is_autoconfigure_address=None, is_loopback=None, is_immortal=None, is_ipv6=None, Destination_Address=None, Origin=None, Netmask=None, Gateway_Address=None, Metric=None, Type=None, Protocol=None, Interface=None, Preferred_Lifetime=None, Valid_Lifetime=None, Route_Age=None, NL_Route_Origin=None):
        super(WindowsNetworkRouteEntryObjectType, self).__init__(object_reference, is_publish, is_autoconfigure_address, is_loopback, is_immortal, is_ipv6, Destination_Address, Origin, Netmask, Gateway_Address, Metric, Type, Protocol, Interface, Preferred_Lifetime, Valid_Lifetime, Route_Age, )
    ...
    def validate_NLRouteOriginType(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='WinNetworkRouteEntryObj:', name_='WindowsNetworkRouteEntryObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='WindowsNetworkRouteEntryObjectType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinNetworkRouteEntryObj:', name_='WindowsNetworkRouteEntryObjectType'):
        super(WindowsNetworkRouteEntryObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='WindowsNetworkRouteEntryObjectType')
    def exportChildren(self, outfile, level, namespace_='WinNetworkRouteEntryObj:', name_='WindowsNetworkRouteEntryObjectType', fromsubclass_=False, pretty_print=True):
        super(WindowsNetworkRouteEntryObjectType, self).exportChildren(outfile, level, 'WinNetworkRouteEntryObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
