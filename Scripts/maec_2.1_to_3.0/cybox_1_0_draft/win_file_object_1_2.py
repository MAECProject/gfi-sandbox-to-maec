...
#
# Generated Fri Nov 30 13:20:06 2012 by generateDS.py version 2.7c.
#
...
import file_object_1_2
import win_computer_account_object_1_2
...
class WindowsFilePermissionsType(file_object_1_2.FilePermissionsType):
    """The WindowsFilePermissionsType type specifies Windows file
    permissions. It imports and extends the file_object_1_2.FilePermissionsType from
    the CybOX File Object."""
    subclass = None
    superclass = file_object_1_2.FilePermissionsType
...
class WindowsFileAttributeType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(WindowsFileAttributeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class WindowsFileAttributesType(file_object_1_2.FileAttributeType):
    """The WindowsFileAttributesType type specifies Windows file
    attributes. It imports and extends the file_object_1_2.FileAttributeType from
    the CybOX File Object."""
    subclass = None
    superclass = file_object_1_2.FileAttributeType
...
class StreamObjectType(common_types_1_0.HashListType):
    """The StreamObjectType type is intended to characterize NTFS alternate
    data streams."""
    subclass = None
    superclass = common_types_1_0.HashListType
...
class WindowsFileObjectType(file_object_1_2.FileObjectType):
    """The WindowsFileObjectType type is intended to characterize Windows
    files."""
    subclass = None
    superclass = file_object_1_2.FileObjectType
