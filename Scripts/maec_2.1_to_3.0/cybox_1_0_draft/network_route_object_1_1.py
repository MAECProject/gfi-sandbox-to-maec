...
#
# Generated Fri Nov 30 13:18:22 2012 by generateDS.py version 2.7c.
#
...
class NetworkRouteEntriesType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Network_Route_Entry_ in self.Network_Route_Entry:
            ...
            Network_Route_Entry_.exportLiteral(outfile, level, name_='network_route_entry_object_1_0.NetworkRouteEntryObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class NetRouteObjectType(common_types_1_0.DefinedObjectType):
