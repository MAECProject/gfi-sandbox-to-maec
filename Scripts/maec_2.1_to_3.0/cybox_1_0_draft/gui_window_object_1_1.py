...
#
# Generated Fri Nov 30 13:17:26 2012 by generateDS.py version 2.7c.
#
...
class GUIWindowObjectType(gui_object_1_1.GUIObjectType):
    """The GUIWindowObjectType is intended to characterize GUI windows."""
    subclass = None
    superclass = gui_object_1_1.GUIObjectType
    def __init__(self, object_reference=None, Height=None, Width=None, Owner_Window=None, Parent_Window=None, Window_Display_Name=None):
        super(GUIWindowObjectType, self).__init__(object_reference, Height, Width, )
    ...
    def export(self, outfile, level, namespace_='GUIWindowObj:', name_='GUIWindowObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='GUIWindowObj:', name_='GUIWindowObjectType', fromsubclass_=False, pretty_print=True):
        super(GUIWindowObjectType, self).exportChildren(outfile, level, 'GUIWindowObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Owner_Window is not None:
            self.Owner_Window.export(outfile, level, 'GUIWindowObj:', name_='Owner_Window', pretty_print=pretty_print)
