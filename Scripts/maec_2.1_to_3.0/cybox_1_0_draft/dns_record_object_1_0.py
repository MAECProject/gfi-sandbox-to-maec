...
#
# Generated Fri Nov 30 13:17:09 2012 by generateDS.py version 2.7c.
#
...
class DNSRecordObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Domain_Name is not None:
            showIndent(outfile, level)
            outfile.write('Domain_Name=model_.uri_object_1_1.URIObjectType(\n')
        ...
        if self.TTL is not None:
            showIndent(outfile, level)
            outfile.write('TTL=model_.common_types_1_0.IntegerObjectAttributeType(\n')
        ...
        if self.Data_Length is not None:
            showIndent(outfile, level)
            outfile.write('Data_Length=model_.common_types_1_0.IntegerObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Description':
            ...
            obj_ = uri_object_1_1.URIObjectType.factory()
            obj_.build(child_)
