...
#
# Generated Fri Nov 30 13:56:26 2012 by generateDS.py version 2.7c.
#
...
class MeasureSourceType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='Common:', name_='MeasureSourceType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Indicators is not None:
            self.Indicators.export(outfile, level, 'Common:', name_='Indicators', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.System is not None:
            showIndent(outfile, level)
            outfile.write('System=model_.system_object_1_2.SystemObjectType(\n')
            self.System.exportLiteral(outfile, level, name_='System')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Instance is not None:
            showIndent(outfile, level)
            outfile.write('Instance=model_.process_object_1_2.ProcessObjectType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Description':
            ...
            obj_ = system_object_1_2.SystemObjectType.factory()
            obj_.build(child_)
            self.set_System(obj_)
        elif nodeName_ == 'Instance':
            obj_ = process_object_1_2.ProcessObjectType.factory()
            obj_.build(child_)
...
class ExecutionEnvironmentType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.User_Account_Info is not None:
            showIndent(outfile, level)
            outfile.write('User_Account_Info=model_.user_account_object_1_1.UserAccountObjectType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'System':
            ...
            obj_ = user_account_object_1_1.UserAccountObjectType.factory()
            obj_.build(child_)
...
class IndicatorsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='Common:', name_='IndicatorsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='Common:', name_='IndicatorsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='Common:', name_='IndicatorsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Indicator_ in self.get_Indicator():
            Indicator_.export(outfile, level, 'Common:', name_='Indicator', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Indicator
            ):
...
class IndicatorType(GeneratedsSuper):
    ...
    factory = staticmethod(factory)
    def export(self, outfile, level, namespace_='Common:', name_='IndicatorType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='Common:', name_='IndicatorType'):
        pass
    def exportChildren(self, outfile, level, namespace_='Common:', name_='IndicatorType', fromsubclass_=False, pretty_print=True):
        pass
    def hasContent_(self):
        if (
...
class StringObjectAttributeType(BaseObjectAttributeType):
    ...
    superclass = BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(StringObjectAttributeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class HexBinaryObjectAttributeType(BaseObjectAttributeType):
    ...
    superclass = BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(HexBinaryObjectAttributeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class CodeSnippetsType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Code_Snippet_ in self.Code_Snippet:
            showIndent(outfile, level)
            outfile.write('model_.code_object_1_0.CodeObjectType(\n')
            Code_Snippet_.exportLiteral(outfile, level, name_='code_object_1_0.CodeObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Code_Snippet':
            obj_ = code_object_1_0.CodeObjectType.factory()
            obj_.build(child_)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from cybox_common_draft import *\n\n')
    sys.stdout.write('import cybox_common_draft as model_\n\n')
...
import system_object_1_2
import process_object_1_2
import code_object_1_0
