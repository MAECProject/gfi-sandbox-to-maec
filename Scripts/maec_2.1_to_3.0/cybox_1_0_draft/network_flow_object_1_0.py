...
#
# Generated Fri Nov 30 13:17:43 2012 by generateDS.py version 2.7c.
#
...
import network_packet_object_1_0
...
class NetworkLayerInfoType(GeneratedsSuper):
    ...
    def validate_IANAAssignedIPNumbersType(self, value):
        # Validate type network_packet_object_1_0.IANAAssignedIPNumbersType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Src_IP is not None:
            showIndent(outfile, level)
            outfile.write('Src_IP=model_.address_object_1_1.AddressObjectType(\n')
            self.Src_IP.exportLiteral(outfile, level, name_='Src_IP')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Dest_IP is not None:
            showIndent(outfile, level)
            outfile.write('Dest_IP=model_.address_object_1_1.AddressObjectType(\n')
            self.Dest_IP.exportLiteral(outfile, level, name_='Dest_IP')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Src_Port is not None:
            showIndent(outfile, level)
            outfile.write('Src_Port=model_.port_object_1_2.PortObjectType(\n')
            self.Src_Port.exportLiteral(outfile, level, name_='Src_Port')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Dest_Port is not None:
            showIndent(outfile, level)
            outfile.write('Dest_Port=model_.port_object_1_2.PortObjectType(\n')
            self.Dest_Port.exportLiteral(outfile, level, name_='Dest_Port')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IP_Protocol is not None:
            showIndent(outfile, level)
            outfile.write('IP_Protocol=model_.network_packet_object_1_0.IANAAssignedIPNumbersType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Src_IP':
            ...
            obj_ = network_packet_object_1_0.IANAAssignedIPNumbersType.factory()
            obj_.build(child_)
...
class NetworkFlowLabelType(NetworkLayerInfoType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Ingress_Interface_Index is not None:
            showIndent(outfile, level)
            outfile.write('Ingress_Interface_Index=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Ingress_Interface_Index.exportLiteral(outfile, level, name_='Ingress_Interface_Index')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Egress_Interface_Index is not None:
            showIndent(outfile, level)
            outfile.write('Egress_Interface_Index=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Egress_Interface_Index.exportLiteral(outfile, level, name_='Egress_Interface_Index')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IP_Type_Of_Service is not None:
            showIndent(outfile, level)
            outfile.write('IP_Type_Of_Service=%s,\n' % quote_python(self.IP_Type_Of_Service).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class IPFIXMessageHeaderType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Byte_Length is not None:
            showIndent(outfile, level)
            outfile.write('Byte_Length=%s,\n' % quote_python(self.Byte_Length).encode(ExternalEncoding))
        if self.Export_Timestamp is not None:
            showIndent(outfile, level)
            outfile.write('Export_Timestamp=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Export_Timestamp.exportLiteral(outfile, level, name_='Export_Timestamp')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Sequence_Number is not None:
            showIndent(outfile, level)
            outfile.write('Sequence_Number=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Sequence_Number.exportLiteral(outfile, level, name_='Sequence_Number')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Observation_Domain_ID is not None:
            showIndent(outfile, level)
            outfile.write('Observation_Domain_ID=model_.common_types_1_0.IntegerObjectAttributeType(\n')
...
class IPFIXSetHeaderType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Set_ID is not None:
            showIndent(outfile, level)
            outfile.write('Set_ID=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Set_ID.exportLiteral(outfile, level, name_='Set_ID')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Length is not None:
            showIndent(outfile, level)
            outfile.write('Length=model_.common_types_1_0.IntegerObjectAttributeType(\n')
...
class IPFIXTemplateRecordHeaderType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Template_ID is not None:
            showIndent(outfile, level)
            outfile.write('Template_ID=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Template_ID.exportLiteral(outfile, level, name_='Template_ID')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Field_Count is not None:
            showIndent(outfile, level)
            outfile.write('Field_Count=%s,\n' % quote_python(self.Field_Count).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class IPFIXTemplateRecordFieldSpecifiersType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Information_Element_ID is not None:
            showIndent(outfile, level)
            outfile.write('Information_Element_ID=%s,\n' % quote_python(self.Information_Element_ID).encode(ExternalEncoding))
        if self.Field_Length is not None:
            showIndent(outfile, level)
            outfile.write('Field_Length=%s,\n' % quote_python(self.Field_Length).encode(ExternalEncoding))
        if self.Enterprise_Number is not None:
            showIndent(outfile, level)
            outfile.write('Enterprise_Number=%s,\n' % quote_python(self.Enterprise_Number).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class IPFIXOptionsTemplateRecordHeaderType(GeneratedsSuper):
    ...
    def validate_PositiveIntegerObjectAttributeType(self, value):
        # Validate type common_types_1_0.PositiveIntegerObjectAttributeType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Scope_Field_Count is not None:
            showIndent(outfile, level)
            outfile.write('Scope_Field_Count=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Template_ID':
            ...
            obj_ = common_types_1_0.PositiveIntegerObjectAttributeType.factory()
            obj_.build(child_)
...
class IPFIXOptionsTemplateRecordFieldSpecifiersType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Scope_Information_Element_ID is not None:
            showIndent(outfile, level)
            outfile.write('Scope_Information_Element_ID=%s,\n' % quote_python(self.Scope_Information_Element_ID).encode(ExternalEncoding))
        if self.Scope_Field_Length is not None:
            showIndent(outfile, level)
            outfile.write('Scope_Field_Length=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Scope_Field_Length.exportLiteral(outfile, level, name_='Scope_Field_Length')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Scope_Enterprise_Number is not None:
            showIndent(outfile, level)
            outfile.write('Scope_Enterprise_Number=%s,\n' % quote_python(self.Scope_Enterprise_Number).encode(ExternalEncoding))
        if self.Option_Enterprise_Bit is not None:
            showIndent(outfile, level)
            outfile.write('Option_Enterprise_Bit=%s,\n' % self.Option_Enterprise_Bit)
        if self.Option_Information_Element_ID is not None:
            showIndent(outfile, level)
            outfile.write('Option_Information_Element_ID=%s,\n' % quote_python(self.Option_Information_Element_ID).encode(ExternalEncoding))
        if self.Option_Field_Length is not None:
            showIndent(outfile, level)
            outfile.write('Option_Field_Length=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Option_Field_Length.exportLiteral(outfile, level, name_='Option_Field_Length')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Option_Enterprise_Number is not None:
            showIndent(outfile, level)
            outfile.write('Option_Enterprise_Number=%s,\n' % quote_python(self.Option_Enterprise_Number).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class IPFIXDataRecordType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='NetFlowObj:', name_='IPFIXDataRecordType', fromsubclass_=False, pretty_print=True):
        ...
        for Field_Value_ in self.Field_Value:
            self.Field_Value.export(outfile, level, 'NetFlowObj:', name_='Field_Value', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Field_Value
            ):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Field_Value_ in self.Field_Value:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(Field_Value_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
...
class NetflowV9PacketHeaderType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Record_Count is not None:
            showIndent(outfile, level)
            outfile.write('Record_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Record_Count.exportLiteral(outfile, level, name_='Record_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Sys_Up_Time is not None:
            showIndent(outfile, level)
            outfile.write('Sys_Up_Time=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Sys_Up_Time.exportLiteral(outfile, level, name_='Sys_Up_Time')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Unix_Secs is not None:
            showIndent(outfile, level)
            outfile.write('Unix_Secs=model_.common_types_1_0.IntegerObjectAttributeType(\n')
        ...
        if self.Source_ID is not None:
            showIndent(outfile, level)
            outfile.write('Source_ID=%s,\n' % quote_python(self.Source_ID).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class NetflowV9TemplateFlowSetType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Flow_Set_ID is not None:
            showIndent(outfile, level)
            outfile.write('Flow_Set_ID=%s,\n' % quote_python(self.Flow_Set_ID).encode(ExternalEncoding))
        if self.Length is not None:
            showIndent(outfile, level)
            outfile.write('Length=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Length.exportLiteral(outfile, level, name_='Length')
...
class NetflowV9TemplateRecordType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Field_Count is not None:
            showIndent(outfile, level)
            outfile.write('Field_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
...
class NetflowV9OptionsTemplateRecordType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Option_Scope_Length is not None:
            showIndent(outfile, level)
            outfile.write('Option_Scope_Length=%s,\n' % quote_python(self.Option_Scope_Length).encode(ExternalEncoding))
        if self.Option_Length is not None:
            showIndent(outfile, level)
            outfile.write('Option_Length=%s,\n' % quote_python(self.Option_Length).encode(ExternalEncoding))
        if self.Scope_Field_Type is not None:
            showIndent(outfile, level)
        ...
        if self.Scope_Field_Length is not None:
            showIndent(outfile, level)
            outfile.write('Scope_Field_Length=%s,\n' % quote_python(self.Scope_Field_Length).encode(ExternalEncoding))
        if self.Option_Field_Type is not None:
            showIndent(outfile, level)
        ...
        if self.Option_Field_Length is not None:
            showIndent(outfile, level)
            outfile.write('Option_Field_Length=%s,\n' % quote_python(self.Option_Field_Length).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class NetflowV9DataFlowSetType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Flow_Set_ID_Template_ID is not None:
            showIndent(outfile, level)
            outfile.write('Flow_Set_ID_Template_ID=model_.common_types_1_0.IntegerObjectAttributeType(\n')
...
class FlowCollectionElementType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='NetFlowObj:', name_='FlowCollectionElementType', fromsubclass_=False, pretty_print=True):
        ...
        for Flow_Record_Field_Value_ in self.Flow_Record_Field_Value:
            self.Flow_Record_Field_Value.export(outfile, level, 'NetFlowObj:', name_='Flow_Record_Field_Value', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Flow_Record_Field_Value
            ):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Flow_Record_Field_Value_ in self.Flow_Record_Field_Value:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(Flow_Record_Field_Value_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
...
class OptionsDataRecordType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Scope_Field_Value is not None:
            showIndent(outfile, level)
            outfile.write('Scope_Field_Value=%s,\n' % quote_python(self.Scope_Field_Value).encode(ExternalEncoding))
        showIndent(outfile, level)
...
class OptionCollectionElementType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='NetFlowObj:', name_='OptionCollectionElementType', fromsubclass_=False, pretty_print=True):
        ...
        for Option_Record_Field_Value_ in self.Option_Record_Field_Value:
            self.Option_Record_Field_Value.export(outfile, level, 'NetFlowObj:', name_='Option_Record_Field_Value', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Option_Record_Field_Value
            ):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Option_Record_Field_Value_ in self.Option_Record_Field_Value:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(Option_Record_Field_Value_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
...
class NetflowV5FlowHeaderType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Version='05', Count=None, Sys_Up_Time=None, Unix_Secs=None, Unix_Nsecs=None, Flow_Sequence=None, Engine_Type=None, Engine_ID=None, Sampling_Interval=None):
        self.Version = Version
        self.Count = Count
        self.Sys_Up_Time = Sys_Up_Time
        self.Unix_Secs = Unix_Secs
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Count is not None:
            showIndent(outfile, level)
            outfile.write('Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
        ...
        if self.Unix_Nsecs is not None:
            showIndent(outfile, level)
            outfile.write('Unix_Nsecs=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Unix_Nsecs.exportLiteral(outfile, level, name_='Unix_Nsecs')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Flow_Sequence is not None:
            showIndent(outfile, level)
            outfile.write('Flow_Sequence=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Flow_Sequence.exportLiteral(outfile, level, name_='Flow_Sequence')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Engine_Type is not None:
            showIndent(outfile, level)
            outfile.write('Engine_Type=%s,\n' % quote_python(self.Engine_Type).encode(ExternalEncoding))
        if self.Engine_ID is not None:
            showIndent(outfile, level)
            outfile.write('Engine_ID=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Engine_ID.exportLiteral(outfile, level, name_='Engine_ID')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Sampling_Interval is not None:
            showIndent(outfile, level)
            outfile.write('Sampling_Interval=%s,\n' % quote_python(self.Sampling_Interval).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class NetflowV5FlowRecordType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Nexthop_IPv4_Addr is not None:
            showIndent(outfile, level)
            outfile.write('Nexthop_IPv4_Addr=model_.address_object_1_1.AddressObjectType(\n')
            self.Nexthop_IPv4_Addr.exportLiteral(outfile, level, name_='Nexthop_IPv4_Addr')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Packet_Count is not None:
            showIndent(outfile, level)
            outfile.write('Packet_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Packet_Count.exportLiteral(outfile, level, name_='Packet_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Byte_Count is not None:
            showIndent(outfile, level)
            outfile.write('Byte_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Byte_Count.exportLiteral(outfile, level, name_='Byte_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SysUpTime_Start is not None:
            showIndent(outfile, level)
            outfile.write('SysUpTime_Start=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.SysUpTime_Start.exportLiteral(outfile, level, name_='SysUpTime_Start')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SysUpTime_End is not None:
            showIndent(outfile, level)
            outfile.write('SysUpTime_End=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.SysUpTime_End.exportLiteral(outfile, level, name_='SysUpTime_End')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Padding1 is not None:
            showIndent(outfile, level)
            outfile.write('Padding1=%s,\n' % quote_python(self.Padding1).encode(ExternalEncoding))
        if self.TCP_Flags is not None:
            showIndent(outfile, level)
            outfile.write('TCP_Flags=%s,\n' % quote_python(self.TCP_Flags).encode(ExternalEncoding))
        if self.Src_Autonomous_System is not None:
            showIndent(outfile, level)
            outfile.write('Src_Autonomous_System=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Src_Autonomous_System.exportLiteral(outfile, level, name_='Src_Autonomous_System')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Dest_Autonomous_System is not None:
            showIndent(outfile, level)
            outfile.write('Dest_Autonomous_System=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Dest_Autonomous_System.exportLiteral(outfile, level, name_='Dest_Autonomous_System')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Src_IP_Mask_Bit_Count is not None:
            showIndent(outfile, level)
            outfile.write('Src_IP_Mask_Bit_Count=%s,\n' % quote_python(self.Src_IP_Mask_Bit_Count).encode(ExternalEncoding))
        if self.Dest_IP_Mask_Bit_Count is not None:
            showIndent(outfile, level)
            outfile.write('Dest_IP_Mask_Bit_Count=%s,\n' % quote_python(self.Dest_IP_Mask_Bit_Count).encode(ExternalEncoding))
        if self.Padding2 is not None:
            showIndent(outfile, level)
            outfile.write('Padding2=%s,\n' % quote_python(self.Padding2).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class SiLKRecordType(GeneratedsSuper):
    ...
    def validate_IANAPortNumberRegistryType(self, value):
        # Validate type network_packet_object_1_0.IANAPortNumberRegistryType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Start_Time is not None:
            showIndent(outfile, level)
            outfile.write('Start_Time=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Start_Time.exportLiteral(outfile, level, name_='Start_Time')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Duration is not None:
            showIndent(outfile, level)
            outfile.write('Duration=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Duration.exportLiteral(outfile, level, name_='Duration')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.End_Time is not None:
            showIndent(outfile, level)
            outfile.write('End_Time=model_.common_types_1_0.IntegerObjectAttributeType(\n')
        ...
        if self.ICMP_Type is not None:
            showIndent(outfile, level)
            outfile.write('ICMP_Type=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.ICMP_Type.exportLiteral(outfile, level, name_='ICMP_Type')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ICMP_Code is not None:
            showIndent(outfile, level)
            outfile.write('ICMP_Code=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.ICMP_Code.exportLiteral(outfile, level, name_='ICMP_Code')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Router_Next_Hop_IP is not None:
            showIndent(outfile, level)
            outfile.write('Router_Next_Hop_IP=model_.address_object_1_1.AddressObjectType(\n')
            self.Router_Next_Hop_IP.exportLiteral(outfile, level, name_='Router_Next_Hop_IP')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Initial_TCP_Flags is not None:
            showIndent(outfile, level)
            outfile.write('Initial_TCP_Flags=model_.network_packet_object_1_0.TCPFlagsType(\n')
            self.Initial_TCP_Flags.exportLiteral(outfile, level, name_='Initial_TCP_Flags')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Session_TCP_Flags is not None:
            showIndent(outfile, level)
            outfile.write('Session_TCP_Flags=%s,\n' % quote_python(self.Session_TCP_Flags).encode(ExternalEncoding))
        if self.Flow_Attributes is not None:
            showIndent(outfile, level)
        ...
        if self.Flow_Application is not None:
            showIndent(outfile, level)
            outfile.write('Flow_Application=model_.network_packet_object_1_0.IANAPortNumberRegistryType(\n')
        ...
        if self.Src_MAPNAME is not None:
            showIndent(outfile, level)
            outfile.write('Src_MAPNAME=%s,\n' % quote_python(self.Src_MAPNAME).encode(ExternalEncoding))
        if self.Dest_MAPNAME is not None:
            showIndent(outfile, level)
            outfile.write('Dest_MAPNAME=%s,\n' % quote_python(self.Dest_MAPNAME).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Packet_Count':
            ...
            obj_ = network_packet_object_1_0.TCPFlagsType.factory()
            obj_.build(child_)
            ...
            obj_ = network_packet_object_1_0.IANAPortNumberRegistryType.factory()
            obj_.build(child_)
...
class SiLKSensorInfoType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Sensor_ID is not None:
            showIndent(outfile, level)
            outfile.write('Sensor_ID=%s,\n' % quote_python(self.Sensor_ID).encode(ExternalEncoding))
        if self.Class is not None:
            showIndent(outfile, level)
...
class YAFFlowType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Flow_Start_Milliseconds is not None:
            showIndent(outfile, level)
            outfile.write('Flow_Start_Milliseconds=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Flow_Start_Milliseconds.exportLiteral(outfile, level, name_='Flow_Start_Milliseconds')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Flow_End_Milliseconds is not None:
            showIndent(outfile, level)
            outfile.write('Flow_End_Milliseconds=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Flow_End_Milliseconds.exportLiteral(outfile, level, name_='Flow_End_Milliseconds')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Octet_Total_Count is not None:
            showIndent(outfile, level)
            outfile.write('Octet_Total_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Octet_Total_Count.exportLiteral(outfile, level, name_='Octet_Total_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Packet_Total_Count is not None:
            showIndent(outfile, level)
            outfile.write('Packet_Total_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Packet_Total_Count.exportLiteral(outfile, level, name_='Packet_Total_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Flow_End_Reason is not None:
            showIndent(outfile, level)
            outfile.write('Flow_End_Reason=%s,\n' % quote_python(self.Flow_End_Reason).encode(ExternalEncoding))
        if self.SiLK_App_Label is not None:
            showIndent(outfile, level)
            outfile.write('SiLK_App_Label=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.SiLK_App_Label.exportLiteral(outfile, level, name_='SiLK_App_Label')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Payload_Entropy is not None:
            showIndent(outfile, level)
            outfile.write('Payload_Entropy=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Payload_Entropy.exportLiteral(outfile, level, name_='Payload_Entropy')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ML_App_Label is not None:
            showIndent(outfile, level)
            outfile.write('ML_App_Label=%s,\n' % quote_python(self.ML_App_Label).encode(ExternalEncoding))
        if self.TCP_Flow is not None:
            showIndent(outfile, level)
        ...
        if self.Vlan_ID_MAC_Addr is not None:
            showIndent(outfile, level)
            outfile.write('Vlan_ID_MAC_Addr=model_.address_object_1_1.AddressObjectType(\n')
        ...
        if self.First_Packet_Banner is not None:
            showIndent(outfile, level)
            outfile.write('First_Packet_Banner=%s,\n' % quote_python(self.First_Packet_Banner).encode(ExternalEncoding))
        if self.Second_Packet_Banner is not None:
            showIndent(outfile, level)
            outfile.write('Second_Packet_Banner=%s,\n' % quote_python(self.Second_Packet_Banner).encode(ExternalEncoding))
        if self.N_Bytes_Payload is not None:
            showIndent(outfile, level)
            outfile.write('N_Bytes_Payload=%s,\n' % quote_python(self.N_Bytes_Payload).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class YAFReverseFlowType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Reverse_Octet_Total_Count is not None:
            showIndent(outfile, level)
            outfile.write('Reverse_Octet_Total_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Reverse_Octet_Total_Count.exportLiteral(outfile, level, name_='Reverse_Octet_Total_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Reverse_Packet_Total_Count is not None:
            showIndent(outfile, level)
            outfile.write('Reverse_Packet_Total_Count=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Reverse_Packet_Total_Count.exportLiteral(outfile, level, name_='Reverse_Packet_Total_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Reverse_Payload_Entropy is not None:
            showIndent(outfile, level)
            outfile.write('Reverse_Payload_Entropy=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Reverse_Payload_Entropy.exportLiteral(outfile, level, name_='Reverse_Payload_Entropy')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Reverse_Flow_Delta_Milliseconds is not None:
            showIndent(outfile, level)
            outfile.write('Reverse_Flow_Delta_Milliseconds=model_.common_types_1_0.IntegerObjectAttributeType(\n')
        ...
        if self.Reverse_Vlan_ID_MAC_Addr is not None:
            showIndent(outfile, level)
            outfile.write('Reverse_Vlan_ID_MAC_Addr=model_.address_object_1_1.AddressObjectType(\n')
        ...
        if self.Reverse_First_Packet is not None:
            showIndent(outfile, level)
            outfile.write('Reverse_First_Packet=%s,\n' % quote_python(self.Reverse_First_Packet).encode(ExternalEncoding))
        if self.Reverse_N_Bytes_Payload is not None:
            showIndent(outfile, level)
            outfile.write('Reverse_N_Bytes_Payload=%s,\n' % quote_python(self.Reverse_N_Bytes_Payload).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class YAFTCPFlowType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.TCP_Sequence_Number is not None:
            showIndent(outfile, level)
            outfile.write('TCP_Sequence_Number=model_.common_types_1_0.IntegerObjectAttributeType(\n')
        ...
        if self.Union_TCP_Flags is not None:
            showIndent(outfile, level)
            outfile.write('Union_TCP_Flags=%s,\n' % quote_python(self.Union_TCP_Flags).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
...
class YAFOSInformationType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.OS_Name is not None:
            showIndent(outfile, level)
            outfile.write('OS_Name=%s,\n' % quote_python(self.OS_Name).encode(ExternalEncoding))
        if self.OS_Version is not None:
            showIndent(outfile, level)
...
class SiLKSensorClassType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(SiLKSensorClassType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class SiLKDirectionType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(SiLKDirectionType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class SiLKCountryCodeType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(SiLKCountryCodeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class SiLKAddressType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(SiLKAddressType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class SiLKFlowAttributesType(common_types_1_0.BaseObjectAttributeType):
    ...
    type. Its base type is the CybOX Core common_types_1_0.BaseObjectAttributeType,
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(SiLKFlowAttributesType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class NetflowV9ScopeFieldType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(NetflowV9ScopeFieldType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class NetflowV9FieldType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(NetflowV9FieldType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class NetworkFlowObjectType(common_types_1_0.DefinedObjectType):
