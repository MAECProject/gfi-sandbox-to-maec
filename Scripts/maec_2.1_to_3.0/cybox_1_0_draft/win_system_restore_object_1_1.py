...
#
# Generated Fri Nov 30 13:21:06 2012 by generateDS.py version 2.7c.
#
...
class HiveListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='WinSystemRestoreObj:', name_='HiveListType', fromsubclass_=False, pretty_print=True):
        ...
        for Hive_ in self.Hive:
            self.Hive.export(outfile, level, 'WinSystemRestoreObj:', name_='Hive', pretty_print=pretty_print)
...
class ChangeLogEntryTypeType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(ChangeLogEntryTypeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class WindowsSystemRestoreObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.ChangeLog_Entry_Sequence_Number is not None:
            showIndent(outfile, level)
            outfile.write('ChangeLog_Entry_Sequence_Number=model_.common_types_1_0.LongObjectAttributeType(\n')
