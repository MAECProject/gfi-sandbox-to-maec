...
#
# Generated Fri Nov 30 13:19:01 2012 by generateDS.py version 2.7c.
#
...
class UnixFileType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(UnixFileType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class UnixFilePermissionsType(file_object_1_2.FilePermissionsType):
...
class UnixFileObjectType(file_object_1_2.FileObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.INode is not None:
            showIndent(outfile, level)
            outfile.write('INode=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
