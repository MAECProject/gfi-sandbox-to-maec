...
#
# Generated Fri Nov 30 13:20:12 2012 by generateDS.py version 2.7c.
#
...
class HandleType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(HandleType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class WindowsHandleObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.ID is not None:
            showIndent(outfile, level)
            outfile.write('ID=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
        ...
        if self.Object_Address is not None:
            showIndent(outfile, level)
            outfile.write('Object_Address=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Object_Address.exportLiteral(outfile, level, name_='Object_Address')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Access_Mask is not None:
            showIndent(outfile, level)
            outfile.write('Access_Mask=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Access_Mask.exportLiteral(outfile, level, name_='Access_Mask')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Pointer_Count is not None:
            showIndent(outfile, level)
            outfile.write('Pointer_Count=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
