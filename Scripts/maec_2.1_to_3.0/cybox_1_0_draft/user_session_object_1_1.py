...
#
# Generated Fri Nov 30 13:19:30 2012 by generateDS.py version 2.7c.
#
...
class UserSessionObjectType(common_types_1_0.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='UserSessionObj:', name_='UserSessionObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='UserSessionObjectType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='UserSessionObj:', name_='UserSessionObjectType'):
        super(UserSessionObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='UserSessionObjectType')
    def exportChildren(self, outfile, level, namespace_='UserSessionObj:', name_='UserSessionObjectType', fromsubclass_=False, pretty_print=True):
        super(UserSessionObjectType, self).exportChildren(outfile, level, 'UserSessionObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Effective_Group is not None:
            self.Effective_Group.export(outfile, level, 'UserSessionObj:', name_='Effective_Group', pretty_print=pretty_print)
        if self.Effective_Group_ID is not None:
            self.Effective_Group_ID.export(outfile, level, 'UserSessionObj:', name_='Effective_Group_ID', pretty_print=pretty_print)
        if self.Effective_User is not None:
            self.Effective_User.export(outfile, level, 'UserSessionObj:', name_='Effective_User', pretty_print=pretty_print)
        if self.Effective_User_ID is not None:
            self.Effective_User_ID.export(outfile, level, 'UserSessionObj:', name_='Effective_User_ID', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Effective_Group is not None:
            showIndent(outfile, level)
            outfile.write('Effective_Group=%s,\n' % quote_python(self.Effective_Group).encode(ExternalEncoding))
        if self.Effective_Group_ID is not None:
            showIndent(outfile, level)
            outfile.write('Effective_Group_ID=%s,\n' % quote_python(self.Effective_Group_ID).encode(ExternalEncoding))
        if self.Effective_User is not None:
            showIndent(outfile, level)
            outfile.write('Effective_User=%s,\n' % quote_python(self.Effective_User).encode(ExternalEncoding))
        if self.Effective_User_ID is not None:
            showIndent(outfile, level)
            outfile.write('Effective_User_ID=%s,\n' % quote_python(self.Effective_User_ID).encode(ExternalEncoding))
        if self.Login_Time is not None:
            showIndent(outfile, level)
            outfile.write('Login_Time=%s,\n' % quote_python(self.Login_Time).encode(ExternalEncoding))
        if self.Logout_Time is not None:
            showIndent(outfile, level)
            outfile.write('Logout_Time=%s,\n' % quote_python(self.Logout_Time).encode(ExternalEncoding))
    def build(self, node):
