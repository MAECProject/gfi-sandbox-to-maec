...
#
# Generated Fri Nov 30 13:17:12 2012 by generateDS.py version 2.7c.
#
...
class AttachmentsType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for File_ in self.File:
            showIndent(outfile, level)
            outfile.write('model_.file_object_1_2.FileObjectType(\n')
            File_.exportLiteral(outfile, level, name_='file_object_1_2.FileObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'File':
            obj_ = file_object_1_2.FileObjectType.factory()
            obj_.build(child_)
...
class EmailHeaderType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.From is not None:
            showIndent(outfile, level)
            outfile.write('From=model_.address_object_1_1.AddressObjectType(\n')
        ...
        if self.Sender is not None:
            showIndent(outfile, level)
            outfile.write('Sender=model_.address_object_1_1.AddressObjectType(\n')
            self.Sender.exportLiteral(outfile, level, name_='Sender')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Reply_To is not None:
            showIndent(outfile, level)
            outfile.write('Reply_To=model_.address_object_1_1.AddressObjectType(\n')
...
class EmailOptionalHeaderType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.X_Originating_IP is not None:
            showIndent(outfile, level)
            outfile.write('X_Originating_IP=model_.address_object_1_1.AddressObjectType(\n')
            self.X_Originating_IP.exportLiteral(outfile, level, name_='X_Originating_IP')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.X_Priority is not None:
            showIndent(outfile, level)
            outfile.write('X_Priority=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
...
class EmailRecipientsType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Recipient_ in self.Recipient:
            ...
            Recipient_.exportLiteral(outfile, level, name_='address_object_1_1.AddressObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class EmailMessageObjectType(common_types_1_0.DefinedObjectType):
    """The EmailMessageObjectType type is intended to characterize an
    individual email message."""
    subclass = None
    superclass = common_types_1_0.DefinedObjectType
    def __init__(self, object_reference=None, Attachments=None, Header=None, Optional_Header=None, Email_Server=None, Raw_Body=None, Raw_Header=None):
