...
#
# Generated Fri Nov 30 13:20:16 2012 by generateDS.py version 2.7c.
#
...
class KernelHookType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(KernelHookType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
    ...
    def export(self, outfile, level, namespace_='WinKernelHookObj:', name_='KernelHookType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='KernelHookType')
        if self.hasContent_():
            outfile.write('>')
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinKernelHookObj:', name_='KernelHookType'):
        super(KernelHookType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='KernelHookType')
...
class WindowsKernelHookObjectType(common_types_1_0.DefinedObjectType):
    ...
    def validate_KernelHookType(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='WinKernelHookObj:', name_='WindowsKernelHookObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='WindowsKernelHookObjectType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinKernelHookObj:', name_='WindowsKernelHookObjectType'):
        super(WindowsKernelHookObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='WindowsKernelHookObjectType')
    def exportChildren(self, outfile, level, namespace_='WinKernelHookObj:', name_='WindowsKernelHookObjectType', fromsubclass_=False, pretty_print=True):
        super(WindowsKernelHookObjectType, self).exportChildren(outfile, level, 'WinKernelHookObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Digital_Signature_Hooking is not None:
            self.Digital_Signature_Hooking.export(outfile, level, 'WinKernelHookObj:', name_='Digital_Signature_Hooking', pretty_print=pretty_print)
        if self.Digital_Signature_Hooked is not None:
            self.Digital_Signature_Hooked.export(outfile, level, 'WinKernelHookObj:', name_='Digital_Signature_Hooked', pretty_print=pretty_print)
        if self.Hooking_Address is not None:
            self.Hooking_Address.export(outfile, level, 'WinKernelHookObj:', name_='Hooking_Address', pretty_print=pretty_print)
        if self.Hook_Description is not None:
            self.Hook_Description.export(outfile, level, 'WinKernelHookObj:', name_='Hook_Description', pretty_print=pretty_print)
        if self.Hooked_Function is not None:
            self.Hooked_Function.export(outfile, level, 'WinKernelHookObj:', name_='Hooked_Function', pretty_print=pretty_print)
        if self.Hooked_Module is not None:
            self.Hooked_Module.export(outfile, level, 'WinKernelHookObj:', name_='Hooked_Module', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Digital_Signature_Hooking is not None:
            showIndent(outfile, level)
            outfile.write('Digital_Signature_Hooking=model_.common_types_1_0.DigitalSignatureInfoType(\n')
            self.Digital_Signature_Hooking.exportLiteral(outfile, level, name_='Digital_Signature_Hooking')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Digital_Signature_Hooked is not None:
            showIndent(outfile, level)
            outfile.write('Digital_Signature_Hooked=model_.common_types_1_0.DigitalSignatureInfoType(\n')
            self.Digital_Signature_Hooked.exportLiteral(outfile, level, name_='Digital_Signature_Hooked')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Hooking_Address is not None:
            showIndent(outfile, level)
            outfile.write('Hooking_Address=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Hooking_Address.exportLiteral(outfile, level, name_='Hooking_Address')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Hook_Description is not None:
            showIndent(outfile, level)
            outfile.write('Hook_Description=%s,\n' % quote_python(self.Hook_Description).encode(ExternalEncoding))
        if self.Hooked_Function is not None:
            showIndent(outfile, level)
            outfile.write('Hooked_Function=%s,\n' % quote_python(self.Hooked_Function).encode(ExternalEncoding))
        if self.Hooked_Module is not None:
            showIndent(outfile, level)
            outfile.write('Hooked_Module=%s,\n' % quote_python(self.Hooked_Module).encode(ExternalEncoding))
        if self.Hooking_Module is not None:
            showIndent(outfile, level)
            outfile.write('Hooking_Module=%s,\n' % quote_python(self.Hooking_Module).encode(ExternalEncoding))
        if self.Type is not None:
            showIndent(outfile, level)
