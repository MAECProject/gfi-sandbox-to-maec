...
#
# Generated Fri Nov 30 13:16:58 2012 by generateDS.py version 2.7c.
#
...
import disk_partition_object_1_2
...
class PartitionListType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Partition_ in self.Partition:
            showIndent(outfile, level)
            outfile.write('model_.disk_partition_object_1_2.DiskPartitionObjectType(\n')
            Partition_.exportLiteral(outfile, level, name_='disk_partition_object_1_2.DiskPartitionObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Partition':
            obj_ = disk_partition_object_1_2.DiskPartitionObjectType.factory()
            obj_.build(child_)
            self.Partition.append(obj_)
# end class PartitionListType

class DiskType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(DiskType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class DiskObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Disk_Name is not None:
            showIndent(outfile, level)
            outfile.write('Disk_Name=%s,\n' % quote_python(self.Disk_Name).encode(ExternalEncoding))
        if self.Disk_Size is not None:
            showIndent(outfile, level)
            outfile.write('Disk_Size=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Disk_Size.exportLiteral(outfile, level, name_='Disk_Size')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Free_Space is not None:
            showIndent(outfile, level)
            outfile.write('Free_Space=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
