...
#
# Generated Fri Nov 30 13:21:29 2012 by generateDS.py version 2.7c.
#
...
class WaitableTimerType(common_types_1_0.BaseObjectAttributeType):
    ...
    Its base type is the CybOX Core common_types_1_0.BaseObjectAttributeType, for
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(WaitableTimerType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
    ...
    def export(self, outfile, level, namespace_='WinWaitableTimerObj:', name_='WaitableTimerType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinWaitableTimerObj:', name_='WaitableTimerType'):
        super(WaitableTimerType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='WaitableTimerType')
...
class WindowsWaitableTimerObjectType(common_types_1_0.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='WinWaitableTimerObj:', name_='WindowsWaitableTimerObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='WinWaitableTimerObj:', name_='WindowsWaitableTimerObjectType', fromsubclass_=False, pretty_print=True):
        super(WindowsWaitableTimerObjectType, self).exportChildren(outfile, level, 'WinWaitableTimerObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Handle is not None:
            self.Handle.export(outfile, level, 'WinWaitableTimerObj:', name_='Handle', pretty_print=pretty_print)
        if self.Name is not None:
            self.Name.export(outfile, level, 'WinWaitableTimerObj:', name_='Name', pretty_print=pretty_print)
