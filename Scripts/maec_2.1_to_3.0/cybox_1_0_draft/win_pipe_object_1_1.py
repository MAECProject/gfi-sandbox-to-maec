...
#
# Generated Fri Nov 30 13:20:38 2012 by generateDS.py version 2.7c.
#
...
class WindowsPipeObjectType(pipe_object_1_2.PipeObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Default_Time_Out is not None:
            showIndent(outfile, level)
            outfile.write('Default_Time_Out=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
        ...
        if self.In_Buffer_Size is not None:
            showIndent(outfile, level)
            outfile.write('In_Buffer_Size=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
            self.In_Buffer_Size.exportLiteral(outfile, level, name_='In_Buffer_Size')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Max_Instances is not None:
            showIndent(outfile, level)
            outfile.write('Max_Instances=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
        ...
        if self.Out_Buffer_Size is not None:
            showIndent(outfile, level)
            outfile.write('Out_Buffer_Size=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
