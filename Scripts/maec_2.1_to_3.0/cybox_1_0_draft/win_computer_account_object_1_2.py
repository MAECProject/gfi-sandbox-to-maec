...
#
# Generated Fri Nov 30 13:19:36 2012 by generateDS.py version 2.7c.
#
...
class KerberosType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Ticket is not None:
            showIndent(outfile, level)
            outfile.write('Ticket=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
...
class WinComputerAccountObjectType(account_object_1_1.AccountObjectType):
