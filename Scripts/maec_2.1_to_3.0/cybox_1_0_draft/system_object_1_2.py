...
#
# Generated Fri Nov 30 13:18:54 2012 by generateDS.py version 2.7c.
#
...
class BIOSInfoType(GeneratedsSuper):
    ...
    def validate_DateObjectAttributeType(self, value):
        # Validate type common_types_1_0.DateObjectAttributeType, a restriction on xs:date.
        pass
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'BIOS_Date':
            obj_ = common_types_1_0.DateObjectAttributeType.factory()
            obj_.build(child_)
...
class IPGatewayListType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for IP_Gateway_Address_ in self.IP_Gateway_Address:
            showIndent(outfile, level)
            outfile.write('model_.address_object_1_1.AddressObjectType(\n')
            IP_Gateway_Address_.exportLiteral(outfile, level, name_='address_object_1_1.AddressObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class IPInfoType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Subnet_Mask is not None:
            showIndent(outfile, level)
            outfile.write('Subnet_Mask=model_.address_object_1_1.AddressObjectType(\n')
...
class DHCPServerListType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for DHCP_Server_Address_ in self.DHCP_Server_Address:
            showIndent(outfile, level)
            outfile.write('model_.address_object_1_1.AddressObjectType(\n')
            DHCP_Server_Address_.exportLiteral(outfile, level, name_='address_object_1_1.AddressObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SystemObjectType(common_types_1_0.DefinedObjectType):
    ...
    def validate_TimeObjectAttributeType(self, value):
        # Validate type common_types_1_0.TimeObjectAttributeType, a restriction on xs:time.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Available_Physical_Memory is not None:
            showIndent(outfile, level)
            outfile.write('Available_Physical_Memory=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
        ...
        if self.Total_Physical_Memory is not None:
            showIndent(outfile, level)
            outfile.write('Total_Physical_Memory=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Available_Physical_Memory':
            ...
            obj_ = common_types_1_0.TimeObjectAttributeType.factory()
            obj_.build(child_)
...
class OSType(common_types_1_0.CPESpecificationType):
    """The OSType type specifies information about an operating system. It
    imports and extends the common_types_1_0.CPESpecificationType from the CybOX
    Common Types."""
    subclass = None
    superclass = common_types_1_0.CPESpecificationType
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Environment_Variable_List is not None:
            showIndent(outfile, level)
            outfile.write('Environment_Variable_List=model_.common_types_1_0.EnvironmentVariableListType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Bitness':
            ...
            obj_ = common_types_1_0.EnvironmentVariableListType.factory()
            obj_.build(child_)
...
class ProcessorArchType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(ProcessorArchType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class BitnessType(common_types_1_0.BaseObjectAttributeType):
    ...
    the CybOX Core common_types_1_0.BaseObjectAttributeType, for permitting complex
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(BitnessType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
