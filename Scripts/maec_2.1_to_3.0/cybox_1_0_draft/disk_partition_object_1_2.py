...
#
# Generated Fri Nov 30 13:17:02 2012 by generateDS.py version 2.7c.
#
...
class PartitionType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(PartitionType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class DiskPartitionObjectType(common_types_1_0.DefinedObjectType):
    ...
    def validate_NameObjectAttributeType(self, value):
        # Validate type common_types_1_0.NameObjectAttributeType, a restriction on xs:Name.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Partition_ID is not None:
            showIndent(outfile, level)
            outfile.write('Partition_ID=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Partition_ID.exportLiteral(outfile, level, name_='Partition_ID')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Partition_Length is not None:
            showIndent(outfile, level)
            outfile.write('Partition_Length=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Partition_Length.exportLiteral(outfile, level, name_='Partition_Length')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Partition_Offset is not None:
            showIndent(outfile, level)
            outfile.write('Partition_Offset=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Partition_Offset.exportLiteral(outfile, level, name_='Partition_Offset')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Space_Left is not None:
            showIndent(outfile, level)
            outfile.write('Space_Left=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Space_Left.exportLiteral(outfile, level, name_='Space_Left')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Space_Used is not None:
            showIndent(outfile, level)
            outfile.write('Space_Used=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Space_Used.exportLiteral(outfile, level, name_='Space_Used')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Total_Space is not None:
            showIndent(outfile, level)
            outfile.write('Total_Space=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Created':
            ...
            obj_ = common_types_1_0.NameObjectAttributeType.factory()
            obj_.build(child_)
