...
#
# Generated Fri Nov 30 13:20:19 2012 by generateDS.py version 2.7c.
#
...
class SSDTEntryType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Number_Of_Services is not None:
            showIndent(outfile, level)
            outfile.write('Number_Of_Services=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
...
class WindowsKernelObjectType(common_types_1_0.DefinedObjectType):
