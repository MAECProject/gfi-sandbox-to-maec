...
#
# Generated Fri Nov 30 13:19:40 2012 by generateDS.py version 2.7c.
#
...
class WinCriticalSectionObjectType(common_types_1_0.DefinedObjectType):
    ...
    def factory(*args_, **kwargs_):
        if WinCriticalSectionObjectType.subclass:
            return WinCriticalSectionObjectType.subclass(*args_, **kwargs_)
        else:
            return WinCriticalSectionObjectType(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='WinCriticalSectionObj:', name_='WinCriticalSectionObjectType', namespacedef_='', pretty_print=True):
        ...
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='WinCriticalSectionObjectType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinCriticalSectionObj:', name_='WinCriticalSectionObjectType'):
        super(WinCriticalSectionObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='WinCriticalSectionObjectType')
    def exportChildren(self, outfile, level, namespace_='WinCriticalSectionObj:', name_='WinCriticalSectionObjectType', fromsubclass_=False, pretty_print=True):
        super(WinCriticalSectionObjectType, self).exportChildren(outfile, level, 'WinCriticalSectionObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def hasContent_(self):
        if (
            ...
            self.Spin_Count is not None or
            super(WinCriticalSectionObjectType, self).hasContent_()
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='WinCriticalSectionObjectType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(WinCriticalSectionObjectType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Spin_Count is not None:
            showIndent(outfile, level)
            outfile.write('Spin_Count=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
...
# end class WinCriticalSectionObjectType
...
def parse(inFileName):
    ...
    if rootClass is None:
        ...
        rootClass = WinCriticalSectionObjectType
