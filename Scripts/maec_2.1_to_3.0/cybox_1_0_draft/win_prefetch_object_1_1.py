...
#
# Generated Fri Nov 30 13:20:42 2012 by generateDS.py version 2.7c.
#
...
import win_volume_object_1_2
import device_object_1_0
...
class AccessedFileListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='WinPrefetchObj:', name_='AccessedFileListType', fromsubclass_=False, pretty_print=True):
        ...
        for Accessed_Filename_ in self.Accessed_Filename:
            self.Accessed_Filename.export(outfile, level, 'WinPrefetchObj:', name_='Accessed_Filename', pretty_print=pretty_print)
...
class AccessedDirectoryListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='WinPrefetchObj:', name_='AccessedDirectoryListType', fromsubclass_=False, pretty_print=True):
        ...
        for Accessed_Directory_ in self.Accessed_Directory:
            self.Accessed_Directory.export(outfile, level, 'WinPrefetchObj:', name_='Accessed_Directory', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Accessed_Directory
            ):
...
class VolumeType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for VolumeItem_ in self.VolumeItem:
            showIndent(outfile, level)
            outfile.write('model_.win_volume_object_1_2.WindowsVolumeObjectType(\n')
            VolumeItem_.exportLiteral(outfile, level, name_='win_volume_object_1_2.WindowsVolumeObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for DeviceItem_ in self.DeviceItem:
            showIndent(outfile, level)
            outfile.write('model_.device_object_1_0.DeviceObjectType(\n')
            DeviceItem_.exportLiteral(outfile, level, name_='device_object_1_0.DeviceObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'VolumeItem':
            obj_ = win_volume_object_1_2.WindowsVolumeObjectType.factory()
            obj_.build(child_)
            self.VolumeItem.append(obj_)
        elif nodeName_ == 'DeviceItem':
            obj_ = device_object_1_0.DeviceObjectType.factory()
            obj_.build(child_)
            self.DeviceItem.append(obj_)
# end class VolumeType

class WindowsPrefetchObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Times_Executed is not None:
            showIndent(outfile, level)
            outfile.write('Times_Executed=model_.common_types_1_0.LongObjectAttributeType(\n')
