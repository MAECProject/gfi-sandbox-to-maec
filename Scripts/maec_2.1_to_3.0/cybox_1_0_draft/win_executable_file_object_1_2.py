...
#
# Generated Fri Nov 30 13:19:55 2012 by generateDS.py version 2.7c.
#
...
class PEAttributesType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Digital_Signature is not None:
            showIndent(outfile, level)
            outfile.write('Digital_Signature=model_.common_types_1_0.DigitalSignatureInfoType(\n')
        ...
        if self.Extraneous_Bytes is not None:
            showIndent(outfile, level)
            outfile.write('Extraneous_Bytes=model_.common_types_1_0.IntegerObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Base_Address':
            ...
            obj_ = common_types_1_0.DigitalSignatureInfoType.factory()
            obj_.build(child_)
...
class PEChecksumType(GeneratedsSuper):
    ...
    def validate_LongObjectAttributeType(self, value):
        # Validate type common_types_1_0.LongObjectAttributeType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.PE_Computed_API is not None:
            showIndent(outfile, level)
            outfile.write('PE_Computed_API=model_.common_types_1_0.LongObjectAttributeType(\n')
            self.PE_Computed_API.exportLiteral(outfile, level, name_='PE_Computed_API')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.PE_File_API is not None:
            showIndent(outfile, level)
            outfile.write('PE_File_API=model_.common_types_1_0.LongObjectAttributeType(\n')
            self.PE_File_API.exportLiteral(outfile, level, name_='PE_File_API')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.PE_File_Raw is not None:
            showIndent(outfile, level)
            outfile.write('PE_File_Raw=model_.common_types_1_0.LongObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PE_Computed_API':
            obj_ = common_types_1_0.LongObjectAttributeType.factory()
            obj_.build(child_)
...
class PEExportsType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Number_Of_Addresses is not None:
            showIndent(outfile, level)
            outfile.write('Number_Of_Addresses=model_.common_types_1_0.LongObjectAttributeType(\n')
            self.Number_Of_Addresses.exportLiteral(outfile, level, name_='Number_Of_Addresses')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Number_Of_Names is not None:
            showIndent(outfile, level)
            outfile.write('Number_Of_Names=model_.common_types_1_0.LongObjectAttributeType(\n')
...
class EPJumpCodeType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Depth is not None:
            showIndent(outfile, level)
            outfile.write('Depth=model_.common_types_1_0.IntegerObjectAttributeType(\n')
...
class EntropyType(GeneratedsSuper):
    ...
    def validate_FloatObjectAttributeType(self, value):
        # Validate type common_types_1_0.FloatObjectAttributeType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Value is not None:
            showIndent(outfile, level)
            outfile.write('Value=model_.common_types_1_0.FloatObjectAttributeType(\n')
            self.Value.exportLiteral(outfile, level, name_='Value')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Min is not None:
            showIndent(outfile, level)
            outfile.write('Min=model_.common_types_1_0.FloatObjectAttributeType(\n')
            self.Min.exportLiteral(outfile, level, name_='Min')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Max is not None:
            showIndent(outfile, level)
            outfile.write('Max=model_.common_types_1_0.FloatObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Value':
            obj_ = common_types_1_0.FloatObjectAttributeType.factory()
            obj_.build(child_)
            self.set_Value(obj_)
        elif nodeName_ == 'Min':
            obj_ = common_types_1_0.FloatObjectAttributeType.factory()
...
class PEStringType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Hashes is not None:
            showIndent(outfile, level)
            outfile.write('Hashes=model_.common_types_1_0.HashListType(\n')
        ...
        if self.Length is not None:
            showIndent(outfile, level)
            outfile.write('Length=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Encoding':
            ...
            obj_ = common_types_1_0.HashListType.factory()
            obj_.build(child_)
...
class PEExportedFunctionType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Ordinal is not None:
            showIndent(outfile, level)
            outfile.write('Ordinal=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
...
class PESectionType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Data_Hashes is not None:
            showIndent(outfile, level)
            outfile.write('Data_Hashes=model_.common_types_1_0.HashListType(\n')
        ...
        if self.Header_Hashes is not None:
            showIndent(outfile, level)
            outfile.write('Header_Hashes=model_.common_types_1_0.HashListType(\n')
...
class PEDataDirectoryStructType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Size is not None:
            showIndent(outfile, level)
            outfile.write('Size=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
...
class PESectionHeaderStructType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Number_Of_Relocations is not None:
            showIndent(outfile, level)
            outfile.write('Number_Of_Relocations=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
            self.Number_Of_Relocations.exportLiteral(outfile, level, name_='Number_Of_Relocations')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Number_Of_Linenumbers is not None:
            showIndent(outfile, level)
            outfile.write('Number_Of_Linenumbers=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
...
class DOSHeaderType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='WinExecutableFileObj:', name_='DOSHeaderType', fromsubclass_=False, pretty_print=True):
        ...
        for reserved1_ in self.reserved1:
            self.reserved1.export(outfile, level, 'WinExecutableFileObj:', name_='reserved1', pretty_print=pretty_print)
...
class PEFileHeaderType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Number_Of_Sections is not None:
            showIndent(outfile, level)
            outfile.write('Number_Of_Sections=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
        ...
        if self.Number_Of_Symbols is not None:
            showIndent(outfile, level)
            outfile.write('Number_Of_Symbols=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
...
class SectionType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(SectionType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class PEType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(PEType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if PEType.subclass:
...
class DetectedType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(DetectedType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class SubsystemType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(SubsystemType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class WindowsExecutableFileObjectType(win_file_object_1_2.WindowsFileObjectType):
    """The WindowsExecutableFileObjectType type is intended to characterize
    Windows PE (Portable Executable) files."""
    subclass = None
    superclass = win_file_object_1_2.WindowsFileObjectType
