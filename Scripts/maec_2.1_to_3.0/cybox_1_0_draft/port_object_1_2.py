...
#
# Generated Fri Nov 30 13:18:33 2012 by generateDS.py version 2.7c.
#
...
class PortObjectType(common_types_1_0.DefinedObjectType):
    ...
    def validate_Layer4ProtocolType(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='PortObj:', name_='PortObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='PortObj:', name_='PortObjectType'):
        super(PortObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='PortObjectType')
    def exportChildren(self, outfile, level, namespace_='PortObj:', name_='PortObjectType', fromsubclass_=False, pretty_print=True):
        super(PortObjectType, self).exportChildren(outfile, level, 'PortObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Port_Value is not None:
            showIndent(outfile, level)
            outfile.write('Port_Value=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
...
class Layer4ProtocolType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(Layer4ProtocolType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
    ...
    def export(self, outfile, level, namespace_='PortObj:', name_='Layer4ProtocolType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='PortObj:', name_='Layer4ProtocolType'):
