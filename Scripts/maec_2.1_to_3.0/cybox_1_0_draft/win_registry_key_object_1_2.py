...
#
# Generated Fri Nov 30 13:20:50 2012 by generateDS.py version 2.7c.
#
...
class RegistryHiveType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(RegistryHiveType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class RegistryDatatypeType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(RegistryDatatypeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class WindowsRegistryKeyObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Number_Values is not None:
            showIndent(outfile, level)
            outfile.write('Number_Values=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
        ...
        if self.Number_Subkeys is not None:
            showIndent(outfile, level)
            outfile.write('Number_Subkeys=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
