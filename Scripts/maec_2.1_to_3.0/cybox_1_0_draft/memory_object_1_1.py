...
#
# Generated Fri Nov 30 13:17:36 2012 by generateDS.py version 2.7c.
#
...
class MemoryObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Region_Size is not None:
            showIndent(outfile, level)
            outfile.write('Region_Size=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
