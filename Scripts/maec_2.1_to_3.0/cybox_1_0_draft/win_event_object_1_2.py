...
#
# Generated Fri Nov 30 13:19:51 2012 by generateDS.py version 2.7c.
#
...
class EventType(common_types_1_0.BaseObjectAttributeType):
    """EventType specifies Windows event types, via a union of the
    EventTypeEnum type and the atomic xs:string type. Its base type
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(EventType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
    ...
    def export(self, outfile, level, namespace_='WinEventObj:', name_='EventType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinEventObj:', name_='EventType'):
        super(EventType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='EventType')
        if self.datatype is not None and 'datatype' not in already_processed:
            already_processed.append('datatype')
            outfile.write(' datatype=%s' % (quote_attrib(self.datatype), ))
    def exportChildren(self, outfile, level, namespace_='WinEventObj:', name_='EventType', fromsubclass_=False, pretty_print=True):
        super(EventType, self).exportChildren(outfile, level, 'WinEventObj:', name_, True, pretty_print=pretty_print)
        pass
    def hasContent_(self):
        if (
            self.valueOf_ or
            super(EventType, self).hasContent_()
            ):
            return True
        else:
            return False
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        super(EventType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(EventType, self).exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node):
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'datatype' not in already_processed:
            already_processed.append('datatype')
            self.datatype = value
        super(EventType, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class EventType

class WindowsEventObjectType(common_types_1_0.DefinedObjectType):
    ...
    def validate_EventType(self, value):
        # Validate type EventType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Handle is not None:
            showIndent(outfile, level)
            outfile.write('Handle=model_.win_handle_object_1_2.WindowsHandleObjectType(\n')
        ...
        if self.Type is not None:
            showIndent(outfile, level)
            outfile.write('Type=model_.EventType(\n')
