...
#
# Generated Fri Nov 30 13:17:23 2012 by generateDS.py version 2.7c.
#
...
class GUIObjectType(common_types_1_0.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='GUIObj:', name_='GUIObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='GUIObjectType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='GUIObj:', name_='GUIObjectType'):
        super(GUIObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='GUIObjectType')
    def exportChildren(self, outfile, level, namespace_='GUIObj:', name_='GUIObjectType', fromsubclass_=False, pretty_print=True):
        super(GUIObjectType, self).exportChildren(outfile, level, 'GUIObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Height is not None:
            showIndent(outfile, level)
            outfile.write('Height=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.Height.exportLiteral(outfile, level, name_='Height')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Width is not None:
            showIndent(outfile, level)
            outfile.write('Width=model_.common_types_1_0.IntegerObjectAttributeType(\n')
