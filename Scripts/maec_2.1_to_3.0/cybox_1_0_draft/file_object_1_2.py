...
#
# Generated Fri Nov 30 13:17:16 2012 by generateDS.py version 2.7c.
#
...
class FilePathType(common_types_1_0.StringObjectAttributeType):
    ...
    subclass = None
    superclass = common_types_1_0.StringObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, fully_qualified=None, valueOf_=None):
        super(FilePathType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_)        
...
class DigitalSignaturesType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='FileObj:', name_='DigitalSignaturesType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='FileObj:', name_='DigitalSignaturesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='FileObj:', name_='DigitalSignaturesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Digital_Signature is not None:
            self.Digital_Signature.export(outfile, level, 'FileObj:', name_='Digital_Signature', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class FileAttributesListType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='FileObj:', name_='FileAttributesListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='FileObj:', name_='FileAttributesListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='FileObj:', name_='FileAttributesListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for File_Attribute_ in self.get_File_Attribute():
            File_Attribute_.export(outfile, level, 'FileObj:', name_='File_Attribute', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.File_Attribute
            ):
...
class PackerAttributesType(GeneratedsSuper):
    ...
    def validate_PackerType(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='FileObj:', name_='PackerAttributesType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='FileObj:', name_='PackerAttributesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='FileObj:', name_='PackerAttributesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SymLinksListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='FileObj:', name_='SymLinksListType', fromsubclass_=False, pretty_print=True):
        ...
        for Sym_Link_ in self.Sym_Link:
            self.Sym_Link.export(outfile, level, 'FileObj:', name_='Sym_Link', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Sym_Link
            ):
...
class PackerType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(PackerType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='FileObj:', name_='PackerType'):
        super(PackerType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='PackerType')
    ...
    def exportChildren(self, outfile, level, namespace_='FileObj:', name_='PackerType', fromsubclass_=False, pretty_print=True):
        super(PackerType, self).exportChildren(outfile, level, 'FileObj:', name_, True, pretty_print=pretty_print)
        pass
    def hasContent_(self):
        if (
            self.valueOf_ or
            super(PackerType, self).hasContent_()
            ):
            return True
        else:
            return False
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        super(PackerType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(PackerType, self).exportLiteralChildren(outfile, level, name_)
        pass
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        self.valueOf_ = get_all_text_(node)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'datatype' not in already_processed:
            already_processed.append('datatype')
            self.datatype = value
        super(PackerType, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class PackerType

class FileObjectType(common_types_1_0.DefinedObjectType):
    ...
    def validate_DoubleObjectAttributeType(self, value):
        # Validate type common_types_1_0.DoubleObjectAttributeType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Size_In_Bytes is not None:
            showIndent(outfile, level)
            outfile.write('Size_In_Bytes=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
        ...
        if self.Peak_Entropy is not None:
            showIndent(outfile, level)
            outfile.write('Peak_Entropy=model_.common_types_1_0.DoubleObjectAttributeType(\n')
        ...
        if self.Extracted_Features is not None:
            showIndent(outfile, level)
            outfile.write('Extracted_Features=model_.common_types_1_0.ExtractedFeaturesType(\n')
            self.Extracted_Features.exportLiteral(outfile, level, name_='Extracted_Features')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Byte_Runs is not None:
            showIndent(outfile, level)
            outfile.write('Byte_Runs=model_.common_types_1_0.ByteRunsType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'File_Name':
            ...
            obj_ = common_types_1_0.DoubleObjectAttributeType.factory()
            obj_.build(child_)
            ...
            obj_ = common_types_1_0.ExtractedFeaturesType.factory()
            obj_.build(child_)
            self.set_Extracted_Features(obj_)
        elif nodeName_ == 'Byte_Runs':
            obj_ = common_types_1_0.ByteRunsType.factory()
            obj_.build(child_)
