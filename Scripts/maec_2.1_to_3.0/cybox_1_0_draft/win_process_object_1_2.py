...
#
# Generated Fri Nov 30 13:20:46 2012 by generateDS.py version 2.7c.
#
...
import win_handle_object_1_2
import memory_object_1_1
...
class MemorySectionListType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Memory_Section_ in self.Memory_Section:
            showIndent(outfile, level)
            outfile.write('model_.memory_object_1_1.MemoryObjectType(\n')
            Memory_Section_.exportLiteral(outfile, level, name_='memory_object_1_1.MemoryObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Memory_Section':
            obj_ = memory_object_1_1.MemoryObjectType.factory()
            obj_.build(child_)
...
class StartupInfoType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.dwX is not None:
            showIndent(outfile, level)
            outfile.write('dwX=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.dwX.exportLiteral(outfile, level, name_='dwX')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dwY is not None:
            showIndent(outfile, level)
            outfile.write('dwY=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.dwY.exportLiteral(outfile, level, name_='dwY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dwXSize is not None:
            showIndent(outfile, level)
            outfile.write('dwXSize=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
            self.dwXSize.exportLiteral(outfile, level, name_='dwXSize')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dwYSize is not None:
            showIndent(outfile, level)
            outfile.write('dwYSize=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
            self.dwYSize.exportLiteral(outfile, level, name_='dwYSize')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dwXCountChars is not None:
            showIndent(outfile, level)
            outfile.write('dwXCountChars=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
            self.dwXCountChars.exportLiteral(outfile, level, name_='dwXCountChars')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dwYCountChars is not None:
            showIndent(outfile, level)
            outfile.write('dwYCountChars=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
            self.dwYCountChars.exportLiteral(outfile, level, name_='dwYCountChars')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dwFillAttribute is not None:
            showIndent(outfile, level)
            outfile.write('dwFillAttribute=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.dwFillAttribute.exportLiteral(outfile, level, name_='dwFillAttribute')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dwFlags is not None:
            showIndent(outfile, level)
            outfile.write('dwFlags=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.dwFlags.exportLiteral(outfile, level, name_='dwFlags')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.wShowWindow is not None:
            showIndent(outfile, level)
            outfile.write('wShowWindow=model_.common_types_1_0.IntegerObjectAttributeType(\n')
            self.wShowWindow.exportLiteral(outfile, level, name_='wShowWindow')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.hStdInput is not None:
            showIndent(outfile, level)
            outfile.write('hStdInput=model_.win_handle_object_1_2.WindowsHandleObjectType(\n')
            self.hStdInput.exportLiteral(outfile, level, name_='hStdInput')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.hStdOutput is not None:
            showIndent(outfile, level)
            outfile.write('hStdOutput=model_.win_handle_object_1_2.WindowsHandleObjectType(\n')
            self.hStdOutput.exportLiteral(outfile, level, name_='hStdOutput')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.hStdError is not None:
            showIndent(outfile, level)
            outfile.write('hStdError=model_.win_handle_object_1_2.WindowsHandleObjectType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'lpDesktop':
            ...
            obj_ = win_handle_object_1_2.WindowsHandleObjectType.factory()
            obj_.build(child_)
...
class WindowsProcessObjectType(process_object_1_2.ProcessObjectType):
    ...
    def __init__(self, object_reference=None, is_hidden=None, PID=None, Name=None, Path=None, Current_Working_Directory=None, Creation_Time=None, Parent_PID=None, Child_PID_List=None, Argument_List=None, Environment_Variable_List=None, Image_Info=None, Kernel_Time=None, Port_List=None, Network_Connection_List=None, Start_Time=None, Status=None, String_List=None, Username=None, User_Time=None, aslr_enabled=None, dep_enabled=None, Handle_List=None, Priority=None, Section_List=None, Security_ID=None, Startup_Info=None, Security_Type=None, Window_Title=None):
        super(WindowsProcessObjectType, self).__init__(object_reference, is_hidden, PID, Name, Path, Current_Working_Directory, Creation_Time, Parent_PID, Child_PID_List, Argument_List, Environment_Variable_List, Image_Info, Kernel_Time, Port_List, Network_Connection_List, Start_Time, Status, String_List, Username, User_Time, )
    ...
    def validate_SIDType(self, value):
        # Validate type common_types_1_0.SIDType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Handle_List is not None:
            showIndent(outfile, level)
            outfile.write('Handle_List=model_.win_handle_object_1_2.WindowsHandleListType(\n')
        ...
        if self.Security_Type is not None:
            showIndent(outfile, level)
            outfile.write('Security_Type=model_.common_types_1_0.SIDType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Handle_List':
            obj_ = win_handle_object_1_2.WindowsHandleListType.factory()
            obj_.build(child_)
            ...
            obj_ = common_types_1_0.SIDType.factory()
            obj_.build(child_)
