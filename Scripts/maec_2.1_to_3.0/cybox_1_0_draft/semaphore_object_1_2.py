...
#
# Generated Fri Nov 30 13:18:47 2012 by generateDS.py version 2.7c.
#
...
class SemaphoreObjectType(common_types_1_0.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='SemaphoreObj:', name_='SemaphoreObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SemaphoreObjectType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='SemaphoreObj:', name_='SemaphoreObjectType'):
        super(SemaphoreObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='SemaphoreObjectType')
    ...
    def exportChildren(self, outfile, level, namespace_='SemaphoreObj:', name_='SemaphoreObjectType', fromsubclass_=False, pretty_print=True):
        super(SemaphoreObjectType, self).exportChildren(outfile, level, 'SemaphoreObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Current_Count is not None:
            self.Current_Count.export(outfile, level, 'SemaphoreObj:', name_='Current_Count', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Current_Count is not None:
            showIndent(outfile, level)
            outfile.write('Current_Count=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
            self.Current_Count.exportLiteral(outfile, level, name_='Current_Count')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Maximum_Count is not None:
            showIndent(outfile, level)
            outfile.write('Maximum_Count=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
