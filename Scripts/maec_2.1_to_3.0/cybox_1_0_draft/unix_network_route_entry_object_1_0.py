...
#
# Generated Fri Nov 30 13:19:05 2012 by generateDS.py version 2.7c.
#
...
class UnixNetworkRouteEntryObjectType(network_route_entry_object_1_0.NetworkRouteEntryObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.MSS is not None:
            showIndent(outfile, level)
            outfile.write('MSS=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
            self.MSS.exportLiteral(outfile, level, name_='MSS')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Ref is not None:
            showIndent(outfile, level)
            outfile.write('Ref=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Ref.exportLiteral(outfile, level, name_='Ref')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Use is not None:
            showIndent(outfile, level)
            outfile.write('Use=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Use.exportLiteral(outfile, level, name_='Use')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Window is not None:
            showIndent(outfile, level)
            outfile.write('Window=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
