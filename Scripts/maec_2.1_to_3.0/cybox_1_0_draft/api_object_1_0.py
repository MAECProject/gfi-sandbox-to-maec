...
#
# Generated Fri Nov 30 13:16:48 2012 by generateDS.py version 2.7c.
#
...
class APIObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Normalized_Function_Name is not None:
            showIndent(outfile, level)
            outfile.write('Normalized_Function_Name=%s,\n' % quote_python(self.Normalized_Function_Name).encode(ExternalEncoding))
        if self.Platform is not None:
            showIndent(outfile, level)
            outfile.write('Platform=model_.common_types_1_0.CPESpecificationType(\n')
