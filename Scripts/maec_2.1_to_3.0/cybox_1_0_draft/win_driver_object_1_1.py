...
#
# Generated Fri Nov 30 13:19:43 2012 by generateDS.py version 2.7c.
#
...
class DeviceObjectType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='WinDriverObj:', name_='DeviceObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinDriverObj:', name_='DeviceObjectType'):
        pass
    def exportChildren(self, outfile, level, namespace_='WinDriverObj:', name_='DeviceObjectType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Attached_Device_Object is not None:
            showIndent(outfile, level)
            outfile.write('Attached_Device_Object=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
        ...
        if self.Attached_To_Device_Object is not None:
            showIndent(outfile, level)
            outfile.write('Attached_To_Device_Object=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Attached_To_Device_Object.exportLiteral(outfile, level, name_='Attached_To_Device_Object')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Attached_To_Driver_Object is not None:
            showIndent(outfile, level)
            outfile.write('Attached_To_Driver_Object=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
        ...
        if self.Device_Object is not None:
            showIndent(outfile, level)
            outfile.write('Device_Object=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
...
class DeviceObjectListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='WinDriverObj:', name_='DeviceObjectListType', fromsubclass_=False, pretty_print=True):
        ...
        for Device_Object_ in self.Device_Object:
            Device_Object_.export(outfile, level, 'WinDriverObj:', name_='Device_Object_Struct', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Device_Object
            ):
...
class WindowsDriverObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Driver_Init is not None:
            showIndent(outfile, level)
            outfile.write('Driver_Init=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
        ...
        if self.IRP_MJ_CLEANUP is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_CLEANUP=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_CLEANUP.exportLiteral(outfile, level, name_='IRP_MJ_CLEANUP')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_CLOSE is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_CLOSE=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_CLOSE.exportLiteral(outfile, level, name_='IRP_MJ_CLOSE')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_CREATE is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_CREATE=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_CREATE.exportLiteral(outfile, level, name_='IRP_MJ_CREATE')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_CREATE_MAILSLOT is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_CREATE_MAILSLOT=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_CREATE_MAILSLOT.exportLiteral(outfile, level, name_='IRP_MJ_CREATE_MAILSLOT')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_CREATE_NAMED_PIPE is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_CREATE_NAMED_PIPE=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_CREATE_NAMED_PIPE.exportLiteral(outfile, level, name_='IRP_MJ_CREATE_NAMED_PIPE')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_DEVICE_CHANGE is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_DEVICE_CHANGE=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_DEVICE_CHANGE.exportLiteral(outfile, level, name_='IRP_MJ_DEVICE_CHANGE')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_DEVICE_CONTROL is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_DEVICE_CONTROL=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_DEVICE_CONTROL.exportLiteral(outfile, level, name_='IRP_MJ_DEVICE_CONTROL')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_DIRECTORY_CONTROL is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_DIRECTORY_CONTROL=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_DIRECTORY_CONTROL.exportLiteral(outfile, level, name_='IRP_MJ_DIRECTORY_CONTROL')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_FILE_SYSTEM_CONTROL is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_FILE_SYSTEM_CONTROL=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_FILE_SYSTEM_CONTROL.exportLiteral(outfile, level, name_='IRP_MJ_FILE_SYSTEM_CONTROL')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_FLUSH_BUFFERS is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_FLUSH_BUFFERS=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_FLUSH_BUFFERS.exportLiteral(outfile, level, name_='IRP_MJ_FLUSH_BUFFERS')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_INTERNAL_DEVICE_CONTROL is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_INTERNAL_DEVICE_CONTROL=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_INTERNAL_DEVICE_CONTROL.exportLiteral(outfile, level, name_='IRP_MJ_INTERNAL_DEVICE_CONTROL')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_LOCK_CONTROL is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_LOCK_CONTROL=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_LOCK_CONTROL.exportLiteral(outfile, level, name_='IRP_MJ_LOCK_CONTROL')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_PNP is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_PNP=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_PNP.exportLiteral(outfile, level, name_='IRP_MJ_PNP')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_POWER is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_POWER=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_POWER.exportLiteral(outfile, level, name_='IRP_MJ_POWER')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_READ is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_READ=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_READ.exportLiteral(outfile, level, name_='IRP_MJ_READ')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_QUERY_EA is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_QUERY_EA=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_QUERY_EA.exportLiteral(outfile, level, name_='IRP_MJ_QUERY_EA')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_QUERY_INFORMATION is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_QUERY_INFORMATION=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_QUERY_INFORMATION.exportLiteral(outfile, level, name_='IRP_MJ_QUERY_INFORMATION')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_QUERY_SECURITY is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_QUERY_SECURITY=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_QUERY_SECURITY.exportLiteral(outfile, level, name_='IRP_MJ_QUERY_SECURITY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_QUERY_QUOTA is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_QUERY_QUOTA=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_QUERY_QUOTA.exportLiteral(outfile, level, name_='IRP_MJ_QUERY_QUOTA')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_QUERY_VOLUME_INFORMATION is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_QUERY_VOLUME_INFORMATION=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_QUERY_VOLUME_INFORMATION.exportLiteral(outfile, level, name_='IRP_MJ_QUERY_VOLUME_INFORMATION')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_SET_EA is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_SET_EA=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_SET_EA.exportLiteral(outfile, level, name_='IRP_MJ_SET_EA')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_SET_INFORMATION is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_SET_INFORMATION=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_SET_INFORMATION.exportLiteral(outfile, level, name_='IRP_MJ_SET_INFORMATION')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_SET_SECURITY is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_SET_SECURITY=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_SET_SECURITY.exportLiteral(outfile, level, name_='IRP_MJ_SET_SECURITY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_SET_QUOTA is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_SET_QUOTA=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_SET_QUOTA.exportLiteral(outfile, level, name_='IRP_MJ_SET_QUOTA')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_SET_VOLUME_INFORMATION is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_SET_VOLUME_INFORMATION=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_SET_VOLUME_INFORMATION.exportLiteral(outfile, level, name_='IRP_MJ_SET_VOLUME_INFORMATION')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_SHUTDOWN is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_SHUTDOWN=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_SHUTDOWN.exportLiteral(outfile, level, name_='IRP_MJ_SHUTDOWN')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_SYSTEM_CONTROL is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_SYSTEM_CONTROL=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.IRP_MJ_SYSTEM_CONTROL.exportLiteral(outfile, level, name_='IRP_MJ_SYSTEM_CONTROL')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IRP_MJ_WRITE is not None:
            showIndent(outfile, level)
            outfile.write('IRP_MJ_WRITE=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
