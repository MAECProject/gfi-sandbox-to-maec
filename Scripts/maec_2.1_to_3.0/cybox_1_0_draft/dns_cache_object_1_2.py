...
#
# Generated Fri Nov 30 13:17:05 2012 by generateDS.py version 2.7c.
#
...
class DNSCacheEntryType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheEntryType', namespacedef_='', pretty_print=True):
        ...
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DNSCacheEntryType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='DNSCacheObj:', name_='DNSCacheEntryType'):
        pass
    def exportChildren(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheEntryType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.DNS_Entry is not None:
            showIndent(outfile, level)
            outfile.write('DNS_Entry=model_.dns_record_object_1_0.DNSRecordObjectType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'DNS_Entry':
            obj_ = dns_record_object_1_0.DNSRecordObjectType.factory()
            obj_.build(child_)
...
class DNSCacheObjectType(common_types_1_0.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DNSCacheObjectType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='DNSCacheObj:', name_='DNSCacheObjectType'):
        super(DNSCacheObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='DNSCacheObjectType')
    def exportChildren(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheObjectType', fromsubclass_=False, pretty_print=True):
        super(DNSCacheObjectType, self).exportChildren(outfile, level, 'DNSCacheObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
