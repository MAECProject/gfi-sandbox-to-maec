...
#
# Generated Fri Nov 30 13:20:58 2012 by generateDS.py version 2.7c.
#
...
class ServiceDescriptionListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='WinServiceObj:', name_='ServiceDescriptionListType', fromsubclass_=False, pretty_print=True):
        ...
        for Description_ in self.Description:
            self.Description.export(outfile, level, 'WinServiceObj:', name_='Description', pretty_print=pretty_print)
...
class ServiceType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(ServiceType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class ServiceStatusType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(ServiceStatusType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class ServiceModeType(common_types_1_0.BaseObjectAttributeType):
    ...
    superclass = common_types_1_0.BaseObjectAttributeType
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(ServiceModeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.datatype = _cast(None, datatype)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
...
class WindowsServiceObjectType(win_process_object_1_2.WindowsProcessObjectType):
    ...
    verified."""
    subclass = None
    superclass = win_process_object_1_2.WindowsProcessObjectType
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Service_DLL_Hashes is not None:
            showIndent(outfile, level)
            outfile.write('Service_DLL_Hashes=model_.common_types_1_0.HashListType(\n')
