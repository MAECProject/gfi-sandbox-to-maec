...
#
# Generated Fri Nov 30 13:19:26 2012 by generateDS.py version 2.7c.
#
...
class UserAccountObjectType(account_object_1_1.AccountObjectType):
    ...
    subclass = None
    superclass = account_object_1_1.AccountObjectType
    def __init__(self, object_reference=None, disabled=None, locked_out=None, Description=None, Domain=None, password_required=None, User_ID=None, Full_Name=None, Group_List=None, Home_Directory=None, Last_Login=None, Privilege_List=None, Script_Path=None, Username=None, User_Password_Age=None):
    ...
    def exportChildren(self, outfile, level, namespace_='UserAccountObj:', name_='UserAccountObjectType', fromsubclass_=False, pretty_print=True):
        ...
        if self.User_ID is not None:
            self.User_ID.export(outfile, level, 'UserAccountObj:', name_='User_ID', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.User_ID is not None:
            showIndent(outfile, level)
            outfile.write('User_ID=model_.common_types_1_0.IntegerObjectAttributeType(\n')
