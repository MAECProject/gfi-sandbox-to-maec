...
#
# Generated Fri Nov 30 13:21:21 2012 by generateDS.py version 2.7c.
#
...
class WindowsPrivilegeType(user_account_object_1_1.PrivilegeType):
    ...
    def exportChildren(self, outfile, level, namespace_='WinUserAccountObj:', name_='WindowsPrivilegeType', fromsubclass_=False, pretty_print=True):
        super(WindowsPrivilegeType, self).exportChildren(outfile, level, 'WinUserAccountObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class WindowsGroupType(user_account_object_1_1.GroupType):
    ...
    def exportChildren(self, outfile, level, namespace_='WinUserAccountObj:', name_='WindowsGroupType', fromsubclass_=False, pretty_print=True):
        super(WindowsGroupType, self).exportChildren(outfile, level, 'WinUserAccountObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class WindowsUserAccountObjectType(user_account_object_1_1.UserAccountObjectType):
    ...
    def __init__(self, object_reference=None, disabled=None, locked_out=None, Description=None, Domain=None, password_required=None, User_ID=None, Full_Name=None, Group_List=None, Home_Directory=None, Last_Login=None, Privilege_List=None, Script_Path=None, Username=None, User_Password_Age=None, Security_ID=None, Security_Type=None):
        super(WindowsUserAccountObjectType, self).__init__(object_reference, disabled, locked_out, Description, Domain, password_required, User_ID, Full_Name, Group_List, Home_Directory, Last_Login, Privilege_List, Script_Path, Username, User_Password_Age, )
    ...
    def exportChildren(self, outfile, level, namespace_='WinUserAccountObj:', name_='WindowsUserAccountObjectType', fromsubclass_=False, pretty_print=True):
        super(WindowsUserAccountObjectType, self).exportChildren(outfile, level, 'WinUserAccountObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
