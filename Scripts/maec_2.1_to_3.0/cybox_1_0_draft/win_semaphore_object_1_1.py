...
#
# Generated Fri Nov 30 13:20:54 2012 by generateDS.py version 2.7c.
#
...
class WindowsSemaphoreObjectType(semaphore_object_1_2.SemaphoreObjectType):
    """The WindowsSemaphoreObjectType is intended to characterize Windows
    semaphore (synchronization) objects."""
    subclass = None
    superclass = semaphore_object_1_2.SemaphoreObjectType
    def __init__(self, object_reference=None, named=None, Current_Count=None, Maximum_Count=None, Name=None, Handle=None, Security_Attributes=None):
        super(WindowsSemaphoreObjectType, self).__init__(object_reference, named, Current_Count, Maximum_Count, Name, )
        self.Handle = Handle
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="WinSemaphore",
        namespacedef_='')
    return rootObj
