...
#
# Generated Fri Nov 30 13:19:23 2012 by generateDS.py version 2.7c.
#
...
class URIObjectType(common_types_1_0.DefinedObjectType):
    ...
    def validate_AnyURIObjectAttributeType(self, value):
        # Validate type common_types_1_0.AnyURIObjectAttributeType, a restriction on xs:anyURI.
        pass
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Value':
            obj_ = common_types_1_0.AnyURIObjectAttributeType.factory()
            obj_.build(child_)
            self.set_Value(obj_)
