...
#
# Generated Fri Nov 30 13:21:02 2012 by generateDS.py version 2.7c.
#
...
class WindowsSystemObjectType(system_object_1_2.SystemObjectType):
    """The WindowsSystemObjectType type is intended to characterize Windows
    systems."""
    subclass = None
    superclass = system_object_1_2.SystemObjectType
    ...
    def exportChildren(self, outfile, level, namespace_='WinSystemObj:', name_='WindowsSystemObjectType', fromsubclass_=False, pretty_print=True):
        ...
        for Domain_ in self.Domain:
            self.Domain.export(outfile, level, 'WinSystemObj:', name_='Domain', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Open_Handle_List is not None:
            showIndent(outfile, level)
            outfile.write('Open_Handle_List=model_.win_handle_object_1_2.WindowsHandleListType(\n')
