...
#
# Generated Fri Nov 30 13:19:33 2012 by generateDS.py version 2.7c.
#
...
class VolumeFileSystemFlagType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(VolumeFileSystemFlagType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class VolumeObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Total_Allocation_Units is not None:
            showIndent(outfile, level)
            outfile.write('Total_Allocation_Units=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
            self.Total_Allocation_Units.exportLiteral(outfile, level, name_='Total_Allocation_Units')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Sectors_Per_Allocation_Unit is not None:
            showIndent(outfile, level)
            outfile.write('Sectors_Per_Allocation_Unit=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
            self.Sectors_Per_Allocation_Unit.exportLiteral(outfile, level, name_='Sectors_Per_Allocation_Unit')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Bytes_Per_Sector is not None:
            showIndent(outfile, level)
            outfile.write('Bytes_Per_Sector=model_.common_types_1_0.PositiveIntegerObjectAttributeType(\n')
            self.Bytes_Per_Sector.exportLiteral(outfile, level, name_='Bytes_Per_Sector')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Actual_Available_Allocation_Units is not None:
            showIndent(outfile, level)
            outfile.write('Actual_Available_Allocation_Units=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
