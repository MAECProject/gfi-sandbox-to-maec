...
#
# Generated Fri Nov 30 13:18:37 2012 by generateDS.py version 2.7c.
#
...
class NetworkConnectionType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Destination_IP_Address is not None:
            showIndent(outfile, level)
            outfile.write('Destination_IP_Address=model_.address_object_1_1.AddressObjectType(\n')
            self.Destination_IP_Address.exportLiteral(outfile, level, name_='Destination_IP_Address')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Destination_Port is not None:
            showIndent(outfile, level)
            outfile.write('Destination_Port=model_.port_object_1_2.PortObjectType(\n')
            self.Destination_Port.exportLiteral(outfile, level, name_='Destination_Port')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Source_IP_Address is not None:
            showIndent(outfile, level)
            outfile.write('Source_IP_Address=model_.address_object_1_1.AddressObjectType(\n')
            self.Source_IP_Address.exportLiteral(outfile, level, name_='Source_IP_Address')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Source_Port is not None:
            showIndent(outfile, level)
            outfile.write('Source_Port=model_.port_object_1_2.PortObjectType(\n')
...
class ChildPIDListType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Child_PID_ in self.Child_PID:
            ...
            Child_PID_.exportLiteral(outfile, level, name_='common_types_1_0.UnsignedIntegerObjectAttributeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class PortListType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Port_ in self.Port:
            showIndent(outfile, level)
            outfile.write('model_.port_object_1_2.PortObjectType(\n')
            Port_.exportLiteral(outfile, level, name_='port_object_1_2.PortObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ProcessObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportChildren(self, outfile, level, namespace_='ProcessObj:', name_='ProcessObjectType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Current_Working_Directory is not None:
            self.Current_Working_Directory.export(outfile, level, 'ProcessObj:', name_='Current_Working_Directory', pretty_print=pretty_print)
        if self.Creation_Time is not None:
            self.Creation_Time.export(outfile, level, 'ProcessObj:', name_='Creation_Time', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.PID is not None:
            showIndent(outfile, level)
            outfile.write('PID=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
        ...
        if self.Parent_PID is not None:
            showIndent(outfile, level)
            outfile.write('Parent_PID=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
        ...
        if self.String_List is not None:
            showIndent(outfile, level)
            outfile.write('String_List=model_.common_types_1_0.ExtractedStringsType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'PID':
            ...
            obj_ = common_types_1_0.StringObjectAttributeType.factory()
            obj_.build(child_)
            self.set_Current_Working_Directory(obj_)
            ...
            obj_ = common_types_1_0.ExtractedStringsType.factory()
            obj_.build(child_)
...
class ConnectionStateType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(ConnectionStateType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
