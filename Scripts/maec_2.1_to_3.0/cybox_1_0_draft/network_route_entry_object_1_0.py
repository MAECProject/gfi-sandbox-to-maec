...
#
# Generated Fri Nov 30 13:18:18 2012 by generateDS.py version 2.7c.
#
...
class RouteType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(RouteType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class NetworkRouteEntryObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Destination_Address is not None:
            showIndent(outfile, level)
            outfile.write('Destination_Address=model_.address_object_1_1.AddressObjectType(\n')
            self.Destination_Address.exportLiteral(outfile, level, name_='Destination_Address')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Origin is not None:
            showIndent(outfile, level)
            outfile.write('Origin=model_.address_object_1_1.AddressObjectType(\n')
            self.Origin.exportLiteral(outfile, level, name_='Origin')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Netmask is not None:
            showIndent(outfile, level)
            outfile.write('Netmask=model_.address_object_1_1.AddressObjectType(\n')
            self.Netmask.exportLiteral(outfile, level, name_='Netmask')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Gateway_Address is not None:
            showIndent(outfile, level)
            outfile.write('Gateway_Address=model_.address_object_1_1.AddressObjectType(\n')
            self.Gateway_Address.exportLiteral(outfile, level, name_='Gateway_Address')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Metric is not None:
            showIndent(outfile, level)
            outfile.write('Metric=model_.common_types_1_0.UnsignedLongObjectAttributeType(\n')
