...
#
# Generated Thu Dec 06 15:52:16 2012 by generateDS.py version 2.7c.
#
...
class ObservablesType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Observable_Package_Source is not None:
            showIndent(outfile, level)
            outfile.write('Observable_Package_Source=model_.common_types_1_0.MeasureSourceType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Observable_Package_Source':
            obj_ = common_types_1_0.MeasureSourceType.factory()
            obj_.build(child_)
...
class ObservableType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Observable_Source is not None:
            showIndent(outfile, level)
            outfile.write('Observable_Source=model_.common_types_1_0.MeasureSourceType(\n')
...
class EventType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Producer_Observer is not None:
            showIndent(outfile, level)
            outfile.write('Producer_Observer=model_.common_types_1_0.MeasureSourceType(\n')
...
class ActionType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='cybox:', name_='ActionType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Action_Name is not None:
            self.Action_Name.export(outfile, level, 'cybox:', name_='Action_Name', pretty_print=pretty_print)
        if self.Description is not None:
            self.Description.export(outfile, level, 'cybox:', name_='Description', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Discovery_Method is not None:
            showIndent(outfile, level)
            outfile.write('Discovery_Method=model_.common_types_1_0.MeasureSourceType(\n')
...
class ActionNameType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='cybox:', name_='ActionNameType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='cybox:', name_='ActionNameType'):
        pass
    def exportChildren(self, outfile, level, namespace_='cybox:', name_='ActionNameType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Defined_Name is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDefined_Name>%s</%sDefined_Name>%s' % ('cybox:', self.gds_format_string(quote_xml(self.Defined_Name).encode(ExternalEncoding), input_name='Defined_Name'), 'cybox:', eol_))
        if self.Undefined_Name is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sUndefined_Name>%s</%sUndefined_Name>%s' % ('cybox:', self.gds_format_string(quote_xml(self.Undefined_Name).encode(ExternalEncoding), input_name='Undefined_Name'), 'cybox:', eol_))
    def hasContent_(self):
        if (
...
class ActionArgumentType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='cybox:', name_='ActionArgumentType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Argument_Name_Defined is not None:
            showIndent(outfile, level, pretty_print)
            self.Argument_Name_Defined.export(outfile, level, 'cybox:', name_='Argument_Name-Defined', pretty_print=pretty_print)
        if self.Argument_Name_Undefined is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sArgument_Name-Undefined>%s</%sArgument_Name-Undefined>%s' % ('cybox:', self.gds_format_string(quote_xml(self.Argument_Name_Undefined).encode(ExternalEncoding), input_name='Argument_Name-Undefined'), 'cybox:', eol_))
...
class ObjectType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Description is not None:
            ...
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.common_types_1_0.DefinedObjectType is not None:
            showIndent(outfile, level)
            outfile.write('common_types_1_0.DefinedObjectType=model_.common_types_1_0.DefinedObjectType(\n')
            self.common_types_1_0.DefinedObjectType.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        ...
        if nodeName_ == 'Description':
            ...
            if type_name_ is not None:
                ...
                if type_name_ == 'AVClassificationsType':
                    exec("from maec_2_1 import AVClassificationsType") in globals()
                class_ = globals()[type_name_]
                obj_ = class_.factory()
                obj_.build(child_)
            else:
...
class DataReadEffectType(DefinedEffectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Data is not None:
            showIndent(outfile, level)
            outfile.write('Data=model_.common_types_1_0.DataSegmentType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Data':
            obj_ = common_types_1_0.DataSegmentType.factory()
            obj_.build(child_)
            self.set_Data(obj_)
...
class AttributeType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, name=None, valueOf_=None):
        super(AttributeType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
        self.name = _cast(None, name)
