...
#
# Generated Fri Nov 30 13:21:15 2012 by generateDS.py version 2.7c.
#
...
class ThreadRunningStatusType(common_types_1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, valueOf_=None):
        super(ThreadRunningStatusType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, trend, appears_random, regex_syntax, start_range, idref, id, condition, valueOf_, )
...
class WindowsThreadObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Thread_ID is not None:
            showIndent(outfile, level)
            outfile.write('Thread_ID=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
        ...
        if self.Priority is not None:
            showIndent(outfile, level)
            outfile.write('Priority=model_.common_types_1_0.UnsignedIntegerObjectAttributeType(\n')
        ...
        if self.Stack_Size is not None:
            showIndent(outfile, level)
            outfile.write('Stack_Size=model_.common_types_1_0.NonNegativeIntegerObjectAttributeType(\n')
