...
#
# Generated Fri Nov 30 13:19:47 2012 by generateDS.py version 2.7c.
#
...
class UnformattedMessageListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='WinEventLogObj:', name_='UnformattedMessageListType', fromsubclass_=False, pretty_print=True):
        ...
        for Unformatted_Message_ in self.Unformatted_Message:
            self.Unformatted_Message.export(outfile, level, 'WinEventLogObj:', name_='Unformatted_Message', pretty_print=pretty_print)
...
class WindowsEventLogObjectType(common_types_1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.EID is not None:
            showIndent(outfile, level)
            outfile.write('EID=model_.common_types_1_0.LongObjectAttributeType(\n')
        ...
        if self.Category_Num is not None:
            showIndent(outfile, level)
            outfile.write('Category_Num=model_.common_types_1_0.LongObjectAttributeType(\n')
        ...
        if self.Index is not None:
            showIndent(outfile, level)
            outfile.write('Index=model_.common_types_1_0.LongObjectAttributeType(\n')
            self.Index.exportLiteral(outfile, level, name_='Index')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Reserved is not None:
            showIndent(outfile, level)
            outfile.write('Reserved=model_.common_types_1_0.LongObjectAttributeType(\n')
