...
#
# Generated Fri Dec 07 08:33:18 2012 by generateDS.py version 2.7c.
#
...
import cybox_1_0_draft.cybox_1_0 as cybox
import cybox_1_0_draft.system_object_1_2 as system_object
import cybox_1_0_draft.uri_object_1_1 as uri_object
import cybox_1_0_draft.common_types_1_0 as common
import cybox_1_0_draft.code_object_1_0 as code_object
...
class BehaviorType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Purpose is not None:
            self.Purpose.export(outfile, level, 'maec:', name_='Purpose', pretty_print=pretty_print)
        if self.Description is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDescription>%s</%sDescription>%s' % ('maec:', self.gds_format_string(quote_xml(self.Description).encode(ExternalEncoding), input_name='Description'), 'maec:', eol_))
        if self.Discovery_Method is not None:
            self.Discovery_Method.export(outfile, level, 'maec:', name_='Discovery_Method', pretty_print=pretty_print)
        if self.Associated_Code is not None:
            self.Associated_Code.export(outfile, level, 'maec:', name_='Associated_Code', pretty_print=pretty_print)
        if self.Actions is not None:
            self.Actions.export(outfile, level, 'maec:', name_='Actions', pretty_print=pretty_print)
        if self.Relationships is not None:
            self.Relationships.export(outfile, level, 'maec:', name_='Relationships', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Discovery_Method is not None:
            showIndent(outfile, level)
            outfile.write('Discovery_Method=model_.common.MeasureSourceType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Purpose':
            ...
            obj_ = common.MeasureSourceType.factory()
            obj_.build(child_)
...
class BundleType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BundleType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BundleType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Analyses is not None:
            self.Analyses.export(outfile, level, 'maec:', name_='Analyses', pretty_print=pretty_print)
        if self.Behaviors is not None:
            self.Behaviors.export(outfile, level, 'maec:', name_='Behaviors', pretty_print=pretty_print)
        if self.Actions is not None:
            self.Actions.export(outfile, level, 'maec:', name_='Actions', pretty_print=pretty_print)
        if self.Objects is not None:
            self.Objects.export(outfile, level, 'maec:', name_='Objects', pretty_print=pretty_print)
        if self.Indicators is not None:
            self.Indicators.export(outfile, level, 'maec:', name_='Indicators', pretty_print=pretty_print)
        if self.Collections is not None:
            self.Collections.export(outfile, level, 'maec:', name_='Collections', pretty_print=pretty_print)
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Indicators is not None:
            showIndent(outfile, level)
            outfile.write('Indicators=model_.IndicatorsType1(\n')
...
class Analyses(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Analyses', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Analyses'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Analyses', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Analysis_ in self.Analysis:
            Analysis_.export(outfile, level, 'maec:', name_='Analysis', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Analysis
            ):
...
class Behaviors(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Behaviors', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Behaviors'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Behaviors', fromsubclass_=False, pretty_print=True):
        for Behavior_ in self.Behavior:
            Behavior_.export(outfile, level, 'maec:', name_='Behavior', pretty_print = pretty_print)
    def hasContent_(self):
        if (
            self.Behavior
            ):
...
class Actions(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Actions', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Actions'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Actions', fromsubclass_=False, pretty_print=True):
        for Action_ in self.Action:
            Action_.export(outfile, level, 'maec:', name_='Action', pretty_print = pretty_print)
    def hasContent_(self):
        if (
            self.Action
            ):
...
class Action_References(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Actions', fromsubclass_=False, pretty_print=True):
        for Action_Reference_ in self.Action_Reference:
            Action_Reference_.export(outfile, level, 'maec:', name_='Action_Reference', pretty_print = pretty_print)
    def hasContent_(self):
        if (
            self.Action_Reference
            ):
...
class Objects(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Objects', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Objects'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Objects', fromsubclass_=False, pretty_print=True):
        for Object_ in self.Object:
            Object_.export(outfile, level, 'maec:', name_='Object', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Object
            ):
...
class Indicators(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Indicators', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Indicators'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Indicators', fromsubclass_=False, pretty_print=True):
        for Indicator_ in self.Indicator:
            Indicator_.export(outfile, level, 'maec:', name_='Indicator', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Indicator
            ):
...
class Collections(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Collections', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Collections'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Collections', fromsubclass_=False, pretty_print=True):
        if self.Behavior_Collections is not None:
            self.Behavior_Collections.export(outfile, level, 'maec:', name_='Behavior_Collections', pretty_print=pretty_print)
        if self.Action_Collections is not None:
            self.Action_Collections.export(outfile, level, 'maec:', name_='Action_Collections', pretty_print=pretty_print)
        if self.Object_Collections is not None:
            self.Object_Collections.export(outfile, level, 'maec:', name_='Object_Collections', pretty_print=pretty_print)
        if self.Indicator_Collections is not None:
            self.Indicator_Collections.export(outfile, level, 'maec:', name_='Indicator_Collections', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class Behavior_Collections(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Behavior_Collections', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Behavior_Collections'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Behavior_Collections', fromsubclass_=False, pretty_print=True):
        for Behavior_Collection_ in self.Behavior_Collection:
            Behavior_Collection_.export(outfile, level, 'maec:', name_='Behavior_Collection', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Behavior_Collection
            ):
...
class Action_Collections(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Action_Collections', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Action_Collections'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Action_Collections', fromsubclass_=False, pretty_print=True):
        for Action_Collection_ in self.Action_Collection:
            Action_Collection_.export(outfile, level, 'maec:', name_='Action_Collection', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Action_Collection
            ):
...
class Object_Collections(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Object_Collections', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Object_Collections'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Object_Collections', fromsubclass_=False, pretty_print=True):
        for Object_Collection_ in self.Object_Collection:
            Object_Collection_.export(outfile, level, 'maec:', name_='Object_Collection', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Object_Collection
            ):
...
class Indicator_Collections(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='Indicator_Collections', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='Indicator_Collections'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='Indicator_Collections', fromsubclass_=False, pretty_print=True):
        for Indicator_Collection_ in self.Indicator_Collection:
            Indicator_Collection_.export(outfile, level, 'maec:', name_='Indicator_Collection', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Indicator_Collection
            ):
...
class APICallType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='APICallType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='APICallType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Address is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAddress>%s</%sAddress>%s' % ('maec:', self.gds_format_string(quote_xml(self.Address).encode(ExternalEncoding), input_name='Address'), 'maec:', eol_))
        if self.Return_Value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sReturn_Value>%s</%sReturn_Value>%s' % ('maec:', self.gds_format_string(quote_xml(self.Return_Value).encode(ExternalEncoding), input_name='Return_Value'), 'maec:', eol_))
        if self.Parameters is not None:
            self.Parameters.export(outfile, level, 'maec:', name_='Parameters', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class ActionImplementationType(GeneratedsSuper):
    ...
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def export(self, outfile, level, namespace_='maec:', name_='ActionImplementationType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ActionImplementationType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.append('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ActionImplementationType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Compatible_Platforms is not None:
            self.Compatible_Platforms.export(outfile, level, 'maec:', name_='Compatible_Platforms', pretty_print=pretty_print)
        if self.API_Call is not None:
            self.API_Call.export(outfile, level, 'maec:', name_='API_Call', pretty_print=pretty_print)
        for Code_ in self.Code:
            Code_.export(outfile, level, 'maec:', name_='Code', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class AnalysisType(GeneratedsSuper):
    ...
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def export(self, outfile, level, namespace_='maec:', name_='AnalysisType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='AnalysisType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.append('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AnalysisType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Subject is not None:
            self.Subject.export(outfile, level, 'maec:', name_='Subject', pretty_print=pretty_print)
        if self.Comments is not None:
            self.Comments.export(outfile, level, 'maec:', name_='Comments', pretty_print=pretty_print)
        if self.Summary is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSummary>%s</%sSummary>%s' % ('maec:', self.gds_format_string(quote_xml(self.Summary).encode(ExternalEncoding), input_name='Summary'), 'maec:', eol_))
        if self.Analysts is not None:
            self.Analysts.export(outfile, level, 'maec:', name_='Analysts', pretty_print=pretty_print)
        if self.Analysis_Environment is not None:
            self.Analysis_Environment.export(outfile, level, 'maec:', name_='Analysis_Environment', pretty_print=pretty_print)
        if self.Source is not None:
            self.Source.export(outfile, level, 'maec:', name_='Source', pretty_print=pretty_print)
        if self.Tools is not None:
            self.Tools.export(outfile, level, 'maec:', name_='Tools', pretty_print=pretty_print)
        if self.Findings is not None:
            self.Findings.export(outfile, level, 'maec:', name_='Findings', pretty_print=pretty_print)
        if self.Report is not None:
            self.Report.export(outfile, level, 'maec:', name_='Report', pretty_print=pretty_print)
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Analysts is not None:
            showIndent(outfile, level)
            outfile.write('Analysts=model_.common.PersonnelType(\n')
        ...
        if self.Report is not None:
            showIndent(outfile, level)
            outfile.write('Report=model_.common.StructuredTextType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Subject':
            ...
            obj_ = common.PersonnelType.factory()
            obj_.build(child_)
            ...
            obj_ = common.StructuredTextType.factory()
            obj_.build(child_)
...
class AnalysisEnvironmentType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='AnalysisEnvironmentType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='AnalysisEnvironmentType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AnalysisEnvironmentType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Host_System is not None:
            self.Host_System.export(outfile, level, 'maec:', name_='Host_System', pretty_print=pretty_print)
        if self.Analysis_Systems is not None:
            self.Analysis_Systems.export(outfile, level, 'maec:', name_='Analysis_Systems', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class CVEVulnerabilityType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='CVEVulnerabilityType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='CVEVulnerabilityType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TargetType(GeneratedsSuper):
    ...
    def get_type(self): return self.type_
    def set_type(self, type_): self.type_ = type_
    def export(self, outfile, level, namespace_='maec:', name_='TargetType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='TargetType'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.append('type_')
            outfile.write(' type=%s' % (quote_attrib(self.type_), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='TargetType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Name is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sName>%s</%sName>%s' % ('maec:', self.gds_format_string(quote_xml(self.Name).encode(ExternalEncoding), input_name='Name'), 'maec:', eol_))
        if self.Description is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDescription>%s</%sDescription>%s' % ('maec:', self.gds_format_string(quote_xml(self.Description).encode(ExternalEncoding), input_name='Description'), 'maec:', eol_))
        if self.Targeted_Behaviors is not None:
            self.Targeted_Behaviors.export(outfile, level, 'maec:', name_='Targeted_Behaviors', pretty_print=pretty_print)
        if self.Targeted_Actions is not None:
            self.Targeted_Actions.export(outfile, level, 'maec:', name_='Targeted_Actions', pretty_print=pretty_print)
        if self.Targeted_Objects is not None:
            self.Targeted_Objects.export(outfile, level, 'maec:', name_='Targeted_Objects', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class SourceType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='SourceType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='SourceType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='SourceType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Method is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMethod>%s</%sMethod>%s' % ('maec:', self.gds_format_string(quote_xml(self.Method).encode(ExternalEncoding), input_name='Method'), 'maec:', eol_))
        if self.Reference is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sReference>%s</%sReference>%s' % ('maec:', self.gds_format_string(quote_xml(self.Reference).encode(ExternalEncoding), input_name='Reference'), 'maec:', eol_))
        if self.Organization is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sOrganization>%s</%sOrganization>%s' % ('maec:', self.gds_format_string(quote_xml(self.Organization).encode(ExternalEncoding), input_name='Organization'), 'maec:', eol_))
        if self.URL is not None:
            self.URL.export(outfile, level, 'maec:', name_='URL', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Name is not None or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.URL is not None:
            showIndent(outfile, level)
            outfile.write('URL=model_.uri_object.URIObjectType(\n')
            self.URL.exportLiteral(outfile, level, name_='URL')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
...
class CommentsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='CommentsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='CommentsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='CommentsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Comment_ in self.Comment:
            Comment_.export(outfile, level, 'maec:', name_='Comment', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Comment
            ):
...
class BaseCollectionType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BaseCollectionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BaseCollectionType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Affinity_Type is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAffinity_Type>%s</%sAffinity_Type>%s' % ('maec:', self.gds_format_string(quote_xml(self.Affinity_Type).encode(ExternalEncoding), input_name='Affinity_Type'), 'maec:', eol_))
        if self.Affinity_Degree is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAffinity_Degree>%s</%sAffinity_Degree>%s' % ('maec:', self.gds_format_string(quote_xml(self.Affinity_Degree).encode(ExternalEncoding), input_name='Affinity_Degree'), 'maec:', eol_))
        if self.Description is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDescription>%s</%sDescription>%s' % ('maec:', self.gds_format_string(quote_xml(self.Description).encode(ExternalEncoding), input_name='Description'), 'maec:', eol_))
    def hasContent_(self):
...
class IndicatorCollectionType(BaseCollectionType):
    ...
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def export(self, outfile, level, namespace_='maec:', name_='IndicatorCollectionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='IndicatorCollectionType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.append('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='IndicatorCollectionType', fromsubclass_=False, pretty_print=True):
        super(IndicatorCollectionType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Indicator_List is not None:
            self.Indicator_List.export(outfile, level, 'maec:', name_='Indicator_List', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class BehaviorRelationshipType(GeneratedsSuper):
    ...
    attribute specifies the nature of the mmdef.relationship between
    ...
    def get_type(self): return self.type_
    def set_type(self, type_): self.type_ = type_
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorRelationshipType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehaviorRelationshipType'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.append('type_')
            outfile.write(' type=%s' % (quote_attrib(self.type_), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorRelationshipType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Behavior_Reference_ in self.Behavior_Reference:
            Behavior_Reference_.export(outfile, level, 'maec:', name_='Behavior_Reference', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Behavior_Reference
            ):
...
class AnalysisSubjectType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='AnalysisSubjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='AnalysisSubjectType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AnalysisSubjectType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Object is not None:
            self.Object.export(outfile, level, 'maec:', name_='Object', pretty_print=pretty_print)
        if self.Object_Reference is not None:
            self.Object_Reference.export(outfile, level, 'maec:', name_='Object_Reference', pretty_print=pretty_print)
        if self.URL is not None:
            self.URL.export(outfile, level, 'maec:', name_='URL', pretty_print=pretty_print)
        if self.Field_Data is not None:
            self.Field_Data.export(outfile, level, 'maec:', name_='Field_Data', pretty_print=pretty_print)
        if self.Command_Line is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCommand_Line>%s</%sCommand_Line>%s' % ('maec:', self.gds_format_string(quote_xml(self.Command_Line).encode(ExternalEncoding), input_name='Command_Line'), 'maec:', eol_))
        if self.Analysis_Duration is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAnalysis_Duration>%s</%sAnalysis_Duration>%s' % ('maec:', self.gds_format_float(self.Analysis_Duration, input_name='Analysis_Duration'), 'maec:', eol_))
        if self.Exit_Code is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sExit_Code>%s</%sExit_Code>%s' % ('maec:', self.gds_format_integer(self.Exit_Code, input_name='Exit_Code'), 'maec:', eol_))
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Object is not None:
            showIndent(outfile, level)
            outfile.write('Object=model_.cybox.ObjectType(\n')
        ...
        if self.Field_Data is not None:
            showIndent(outfile, level)
            outfile.write('Field_Data=model_.mmdef.fieldDataEntry(\n')
...
class AnalysisSystemsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='AnalysisSystemsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='AnalysisSystemsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AnalysisSystemsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Analysis_System_ in self.Analysis_System:
            Analysis_System_.export(outfile, level, 'maec:', name_='Analysis_System', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Analysis_System
            ):
...
class AnalysisFindingsType(GeneratedsSuper):
    ...
    def get_Actions(self): return self.Actions
    def set_Actions(self, Actions): self.Actions = Actions
    def export(self, outfile, level, namespace_='maec:', name_='AnalysisFindingsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='AnalysisFindingsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AnalysisFindingsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Behaviors is not None:
            showIndent(outfile, level)
            outfile.write('Behaviors=model_.BehaviorsType1(\n')
            self.Behaviors.exportLiteral(outfile, level, name_='Behaviors')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Actions is not None:
            showIndent(outfile, level)
            outfile.write('Actions=model_.ActionsType2(\n')
            self.Actions.exportLiteral(outfile, level, name_='Actions')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
...
class ParameterType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='ParameterType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ParameterType', fromsubclass_=False, pretty_print=True):
        pass
    def hasContent_(self):
        if (
...
class ToolsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='ToolsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ToolsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ToolsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Tool_ in self.Tool:
            Tool_.export(outfile, level, 'maec:', name_='Tool', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Tool
            ):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Tool_ in self.Tool:
            showIndent(outfile, level)
            outfile.write('model_.common.ToolInformationType(\n')
            Tool_.exportLiteral(outfile, level, name_='common.ToolInformationType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class AssociatedCodeType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='AssociatedCodeType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='AssociatedCodeType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AssociatedCodeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Code_Snippet_ in self.Code_Snippet:
            Code_Snippet_.export(outfile, level, 'maec:', name_='Code_Snippet', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Code_Snippet
            ):
...
class BehaviorPurposeType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorPurposeType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehaviorPurposeType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorPurposeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Vulnerability_Exploit is not None:
            self.Vulnerability_Exploit.export(outfile, level, 'maec:', name_='Vulnerability_Exploit', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Description is not None or
...
class PlatformsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='PlatformsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='PlatformsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='PlatformsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Platform_ in self.Platform:
            Platform_.export(outfile, level, 'maec:', name_='Platform', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Platform
            ):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Platform_ in self.Platform:
            showIndent(outfile, level)
            outfile.write('model_.common.CPESpecificationType(\n')
            Platform_.exportLiteral(outfile, level, name_='common.CPESpecificationType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Platform':
            obj_ = common.CPESpecificationType.factory()
            obj_.build(child_)
...
class VulnerabilityExploitType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='VulnerabilityExploitType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='VulnerabilityExploitType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.CVE is not None:
            self.CVE.export(outfile, level, 'maec:', name_='CVE', pretty_print=pretty_print)
        if self.Targeted_Platforms is not None:
            self.Targeted_Platforms.export(outfile, level, 'maec:', name_='Targeted_Platforms', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class ParametersType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='ParametersType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ParametersType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ParametersType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Parameter_ in self.Parameter:
            Parameter_.export(outfile, level, 'maec:', name_='Parameter', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Parameter
            ):
...
class BehaviorRelationshipsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorRelationshipsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehaviorRelationshipsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorRelationshipsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Relationship_ in self.Relationship:
            Relationship_.export(outfile, level, 'maec:', name_='Relationship', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Relationship
            ):
...
class BehavioralActionsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BehavioralActionsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehavioralActionsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehavioralActionsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CommentType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='CommentType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='CommentType', fromsubclass_=False, pretty_print=True):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
...
class BehaviorListType(GeneratedsSuper):
    ...
    def add_Behavior_Collection(self, value): self.Behavior_Collection.append(value)
    def insert_Behavior_Collection(self, index, value): self.Behavior_Collection[index] = value
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehaviorListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ActionListType(GeneratedsSuper):
    ...
    def add_Action_Collection(self, value): self.Action_Collection.append(value)
    def insert_Action_Collection(self, index, value): self.Action_Collection[index] = value
    def export(self, outfile, level, namespace_='maec:', name_='ActionListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ActionListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ActionListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Action is not None:
            showIndent(outfile, level)
            outfile.write('Action=model_.cybox.ActionType(\n')
...
class ObjectListType(GeneratedsSuper):
    ...
    def add_Object_Collection(self, value): self.Object_Collection.append(value)
    def insert_Object_Collection(self, index, value): self.Object_Collection[index] = value
    def export(self, outfile, level, namespace_='maec:', name_='ObjectListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ObjectListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ObjectListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class IndicatorListType(GeneratedsSuper):
    ...
    def add_Indicator_Collection(self, value): self.Indicator_Collection.append(value)
    def insert_Indicator_Collection(self, index, value): self.Indicator_Collection[index] = value
    def export(self, outfile, level, namespace_='maec:', name_='IndicatorListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='IndicatorListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='IndicatorListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Indicator_ in self.Indicator:
            showIndent(outfile, level)
            outfile.write('model_.common.IndicatorType(\n')
            Indicator_.exportLiteral(outfile, level, name_='common.IndicatorType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class BehaviorReferenceType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorReferenceType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorReferenceType', fromsubclass_=False, pretty_print=True):
        pass
    def hasContent_(self):
        if (
...
class ObjectReferenceType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='ObjectReferenceType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ObjectReferenceType', fromsubclass_=False, pretty_print=True):
        pass
    def hasContent_(self):
        if (
...
class BehaviorReferenceListType(GeneratedsSuper):
    ...
    def add_Behavior_Reference(self, value): self.Behavior_Reference.append(value)
    def insert_Behavior_Reference(self, index, value): self.Behavior_Reference[index] = value
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorReferenceListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehaviorReferenceListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorReferenceListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ActionReferenceListType(GeneratedsSuper):
    ...
    def add_Action_Reference(self, value): self.Action_Reference.append(value)
    def insert_Action_Reference(self, index, value): self.Action_Reference[index] = value
    def export(self, outfile, level, namespace_='maec:', name_='ActionReferenceListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ActionReferenceListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ActionReferenceListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Action_Reference_ in self.Action_Reference:
            showIndent(outfile, level)
            outfile.write('model_.cybox.ActionReferenceType(\n')
            Action_Reference_.exportLiteral(outfile, level, name_='cybox.ActionReferenceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ObjectReferenceListType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='ObjectReferenceListType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ObjectReferenceListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ObjectReferenceListType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for Object_Reference_ in self.Object_Reference:
            Object_Reference_.export(outfile, level, 'maec:', name_='Object_Reference', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Object_Reference
            ):
...
class ActionType(cybox.ActionType):
    ...
    def get_extensiontype_(self): return self.extensiontype_
    def set_extensiontype_(self, extensiontype_): self.extensiontype_ = extensiontype_
    def export(self, outfile, level, namespace_='maec:', name_='ActionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ActionType'):
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
        pass
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ActionType', fromsubclass_=False, pretty_print=True):
        super(ActionType, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if self.Implementation is not None:
            self.Implementation.export(outfile, level, 'maec:', name_='Implementation', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class IndicatorType(common.IndicatorType):
    ...
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def export(self, outfile, level, namespace_='maec:', name_='IndicatorType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='IndicatorType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.append('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='IndicatorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Author is not None:
            showIndent(outfile, level)
            outfile.write('<%sAuthor>%s</%sAuthor>\n' % (namespace_, self.gds_format_string(quote_xml(self.Author).encode(ExternalEncoding), input_name='Author'), namespace_, eol_))
        if self.Description is not None:
            showIndent(outfile, level)
            outfile.write('<%sDescription>%s</%sDescription>\n' % (namespace_, self.gds_format_string(quote_xml(self.Description).encode(ExternalEncoding), input_name='Description'), namespace_, eol_))
        if self.Source is not None:
            self.Source.export(outfile, level, 'maec:', name_='Source', pretty_print=True)
        if self.Comments is not None:
            self.Comments.export(outfile, level, 'maec:', name_='Comments', pretty_print=True)
        if self.Target is not None:
            self.Target.export(outfile, level, 'maec:', name_='Target', pretty_print=True)
        if self.Observables is not None:
            self.Observables.export(outfile, level, 'maec:', name_='Observables', pretty_print=True)
    def hasContent_(self):
        if (
...
class BehavioralActionReferenceType(cybox.ActionReferenceType):
    """The BehavioralActionReferenceType defines an action mmdef.reference that
    ...
    def export(self, outfile, level, namespace_='maec:', name_='BehavioralActionReferenceType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehavioralActionReferenceType', fromsubclass_=False, pretty_print=True):
        super(BehavioralActionReferenceType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        pass
    def hasContent_(self):
        if (
...
class BehavioralActionType(cybox.ActionType):
    ...
    def __init__(self, network_protocol=None, timestamp=None, action_status=None, ordinal_position=None, context=None, idref=None, type_=None, id=None, Action_Name=None, Description=None, Action_Aliases=None, Action_Arguments=None, Discovery_Method=None, Associated_Objects=None, Relationships=None, Frequency=None, behavioral_ordering=None):
        super(BehavioralActionType, self).__init__(network_protocol, timestamp, action_status, ordinal_position, context, idref, type_, id, Action_Name, Description, Action_Aliases, Action_Arguments, Discovery_Method, Associated_Objects, Relationships, Frequency, )
        self.behavioral_ordering = _cast(int, behavioral_ordering)
        pass
    def factory(*args_, **kwargs_):
    ...
    def get_behavioral_ordering(self): return self.behavioral_ordering
    def set_behavioral_ordering(self, behavioral_ordering): self.behavioral_ordering = behavioral_ordering
    def export(self, outfile, level, namespace_='maec:', name_='BehavioralActionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehavioralActionType'):
        ...
        if self.behavioral_ordering is not None and 'behavioral_ordering' not in already_processed:
            already_processed.append('behavioral_ordering')
            outfile.write(' behavioral_ordering="%s"' % self.gds_format_integer(self.behavioral_ordering, input_name='behavioral_ordering'))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehavioralActionType', fromsubclass_=False, pretty_print=True):
        super(BehavioralActionType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class HostSystemType(system_object.SystemObjectType):
    ...
    def __init__(self, object_reference=None, Available_Physical_Memory=None, BIOS_Info=None, Date=None, Hostname=None, Local_Time=None, Network_Interface_List=None, OS=None, Processor=None, Processor_Architecture=None, System_Time=None, Timezone_DST=None, Timezone_Standard=None, Total_Physical_Memory=None, Uptime=None, Username=None, Virtual_Machine=None):
        super(HostSystemType, self).__init__(object_reference, Available_Physical_Memory, BIOS_Info, Date, Hostname, Local_Time, Network_Interface_List, OS, Processor, Processor_Architecture, System_Time, Timezone_DST, Timezone_Standard, Total_Physical_Memory, Uptime, Username, )
    ...
    def export(self, outfile, level, namespace_='maec:', name_='HostSystemType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='HostSystemType', fromsubclass_=False, pretty_print=True):
        super(HostSystemType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Virtual_Machine is not None:
            self.Virtual_Machine.export(outfile, level, 'maec:', name_='Virtual_Machine', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Virtual_Machine is not None or
            super(HostSystemType, self).hasContent_()
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='HostSystemType'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(HostSystemType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(HostSystemType, self).exportLiteralChildren(outfile, level, name_)
        if self.Virtual_Machine is not None:
            showIndent(outfile, level)
            outfile.write('Virtual_Machine=model_.common.CPESpecificationType(\n')
    ...
    def build(self, node):
        ...
        for child in node:
            ...
            self.buildChildren(child, node, nodeName_)
    def buildAttributes(self, node, attrs, already_processed):
        super(HostSystemType, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
...
class AnalysisSystemType(system_object.SystemObjectType):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='AnalysisSystemType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AnalysisSystemType', fromsubclass_=False, pretty_print=True):
        super(AnalysisSystemType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Installed_Programs is not None:
            self.Installed_Programs.export(outfile, level, 'maec:', name_='Installed_Programs', pretty_print=pretty_print)
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Installed_Programs is not None:
            showIndent(outfile, level)
            outfile.write('Installed_Programs=model_.Installed_ProgramsType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Installed_Programs':
            obj_ = Installed_ProgramsType.factory()
            obj_.build(child_)
...
class AVClassificationsType(cybox.DomainSpecificObjectAttributesType):
    ...
    def export(self, outfile, level, namespace_='maec:', name_='AVClassificationsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='maec:', name_='AVClassificationsType', fromsubclass_=False, pretty_print=True):
        super(AVClassificationsType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for AV_Classification_ in self.AV_Classification:
            AV_Classification_.export(outfile, level, 'maec:', name_='AV_Classification', pretty_print=pretty_print)
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for AV_Classification_ in self.AV_Classification:
            showIndent(outfile, level)
            outfile.write('model_.mmdef.classificationObject(\n')
            AV_Classification_.exportLiteral(outfile, level, name_='mmdef.classificationObject')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ObjectCollectionType(BaseCollectionType):
    ...
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def export(self, outfile, level, namespace_='maec:', name_='ObjectCollectionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ObjectCollectionType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.append('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ObjectCollectionType', fromsubclass_=False, pretty_print=True):
        super(ObjectCollectionType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Object_List is not None:
            self.Object_List.export(outfile, level, 'maec:', name_='Object_List', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class ActionCollectionType(BaseCollectionType):
    ...
    mmdef.relationship is unknown, as well as actions whose associated
    ...
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def export(self, outfile, level, namespace_='maec:', name_='ActionCollectionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='ActionCollectionType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.append('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='ActionCollectionType', fromsubclass_=False, pretty_print=True):
        super(ActionCollectionType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Action_List is not None:
            self.Action_List.export(outfile, level, 'maec:', name_='Action_List', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class BehaviorCollectionType(BaseCollectionType):
    ...
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def export(self, outfile, level, namespace_='maec:', name_='BehaviorCollectionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='maec:', name_='BehaviorCollectionType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.append('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='maec:', name_='BehaviorCollectionType', fromsubclass_=False, pretty_print=True):
        super(BehaviorCollectionType, self).exportChildren(outfile, level, 'maec:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Behavior_List is not None:
            self.Behavior_List.export(outfile, level, 'maec:', name_='Behavior_List', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.Purpose is not None or
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from maec_core import *\n\n')
    sys.stdout.write('import maec_core as model_\n\n')
